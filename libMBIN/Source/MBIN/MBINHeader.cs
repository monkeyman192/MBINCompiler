...
namespace libMBIN
{
    ...
    public class MBINHeader : NMSTemplate
    {
        ...
        internal const uint  MBIN_VERSION_1  = 2500;               // vanilla version
        ...
        internal const uint  MBIN_VERSION_2  = 3250;               // vanilla version with ordered fields
        ...
        public bool IsValid => (
            ...
            && ((FormatNMS == MBIN_VERSION_1) || (FormatNMS == MBIN_VERSION_2))
        );
        ...
        public bool IsFormatV0 => (FormatAPI == 0) && (Tag != MBINCVER_TAG) && (FormatNMS == MBIN_VERSION_1);
        public bool IsFormatV1 => (FormatAPI == 0) && (Tag == MBINCVER_TAG) && (FormatNMS == MBIN_VERSION_1);
        public bool IsFormatV2 => (FormatAPI == 2) && (FormatNMS == MBIN_VERSION_1);
        public bool IsFormatV3 => (FormatAPI == 0) && (FormatNMS == MBIN_VERSION_2);
