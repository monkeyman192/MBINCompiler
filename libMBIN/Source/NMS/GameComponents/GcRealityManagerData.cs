...
{
    [NMS(GUID = 0xDFDF14BAD704BE19, NameHash = 0x5930542B7B565329)]
    public class GcRealityManagerData : NMSTemplate
    {
        [NMS(Index = 60, Size = 0x9, EnumType = typeof(GcRealitySubstanceCategory.SubstanceCategoryEnum))]
        /* 0x00000 */ public Colour[] SubstanceCategoryColours;
        [NMS(Index = 58, Size = 0x6, EnumType = typeof(GcPlayerHazardType.HazardEnum))]
        ...
        [NMS(Index = 45, Size = 0x7, EnumType = typeof(GcShipWeapons.ShipWeaponEnum))]
        ...
        [NMS(Index = 67, Size = 0xA, EnumType = typeof(GcMissionFaction.MissionFactionEnum))]
        /* 0x07B08 */ public GcRepShopData[] RepShops;
        [NMS(Index = 46, Size = 0x13, EnumType = typeof(GcPlayerWeapons.WeaponModeEnum))]
        /* 0x07C48 */ public GcPlayerWeaponData[] PlayerWeapons;
        [NMS(Index = 66, Size = 0x10, EnumType = typeof(GcBiomeType.BiomeEnum))]
        /* 0x07D78 */ public GcTechList[] PlanetTechShops;
        [NMS(Index = 54, Size = 0xB)]
        /* 0x07E78 */ public TkIdArray[] MissionBoardRewardOptions;
        [NMS(Index = 48, Size = 0xA, EnumType = typeof(GcMissionFaction.MissionFactionEnum))]
        /* 0x07F28 */ public NMSString0x10[] FactionStandingIDs;
        [NMS(Index = 47, Size = 0x7, EnumType = typeof(GcVehicleType.VehicleTypeEnum))]
        ...
        [NMS(Index = 64, Size = 0x5, EnumType = typeof(StatsEnum))]
        ...
        [NMS(Index = 62, Size = 0xBF, EnumType = typeof(GcStatsTypes.StatsTypeEnum))]
        ...
        [NMS(Index = 51, Size = 0x16, EnumType = typeof(GcMissionType.MissionTypeEnum))]
        ...
        [NMS(Index = 56, Size = 0x3, EnumType = typeof(GcRarity.RarityEnum))]
        /* 0x15A84 */ public float[] WeightedTextWeights;
        [NMS(Index = 0)]
        /* 0x15A90 */ public ushort HomeRealityIteration;
        [NMS(Index = 1)]
        /* 0x15A92 */ public ushort RealityIteration;
        [NMS(Index = 84, Size = 0x5, EnumType = typeof(GcCatalogueGroups.CatalogueGroupEnum))]
        /* 0x15A94 */ public NMSString0x80[] Catalogues;
        [NMS(Index = 20, Size = 0x8C, EnumType = typeof(GcInteractionType.InteractionTypeEnum))]
        ...
        [NMS(Index = 22, Size = 0x7, EnumType = typeof(GcWeightingCurve.WeightingCurveEnum))]
