...
{
    [NMS(GUID = 0xEBD73D335367502C, NameHash = 0xC6DB83D2)]
    public class GcSolarSystemData : NMSTemplate
    {
        [NMS(Index = 28)]
        /* 0x0000 */ public GcPlanetColourData Colours;
        [NMS(Index = 10, Size = 0x20, MxmlName = "Space Poi Positions")]
        ...
        [NMS(Index = 9)]
        /* 0x25D4 */ public bool PrimePlanetsIncludedInPlanetCount;
        [NMS(Index = 16)]
        /* 0x25D5 */ public bool StartWithFreighters;
    }
}
