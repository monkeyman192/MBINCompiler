...
{
    [NMS(GUID = 0xE63D7226FC20CF01, NameHash = 0xBCBC706D)]
    public class GcWeatherEffect : NMSTemplate
    {
        ...
        [NMS(Index = 7)]
        /* 0x100 */ public bool ExclusivePrimaryHazard;
        [NMS(Index = 24)]
        /* 0x101 */ public bool FadeoutAudio;
        [NMS(Index = 23)]
        /* 0x102 */ public bool FadeoutVisuals;
        [NMS(Index = 10)]
        /* 0x103 */ public bool RandomRotationAroundUp;
    }
}
