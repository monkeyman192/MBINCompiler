...
{
    [NMS(GUID = 0x8D2329C853441485, NameHash = 0xFD6B0BE30E218605)]
    public class GcSeasonalGameModeData : NMSTemplate
    {
        [NMS(Index = 69, Size = 0x12)]
        ...
        [NMS(Index = 108)]
        /* 0x35CD */ public bool AlwaysUseSeasonalStationTradeData;
        [NMS(Index = 81)]
        /* 0x35CE */ public bool BlockAggressiveSentinelsInStartSystem;
        [NMS(Index = 11)]
        /* 0x35CF */ public bool BlockFirstSpaceMusic;
        [NMS(Index = 80)]
        /* 0x35D0 */ public bool BlockStormsAtStart;
        [NMS(Index = 101)]
        /* 0x35D1 */ public bool CompatibleWithState;
        [NMS(Index = 36)]
        /* 0x35D2 */ public bool DefaultToPvPOff;
        [NMS(Index = 31)]
        /* 0x35D3 */ public bool DoCommunityMissionTextSubstitutions;
        [NMS(Index = 54)]
        /* 0x35D4 */ public bool ForceAllSystemsAbandoned;
        [NMS(Index = 87)]
        /* 0x35D5 */ public bool ForceDeepSpaceAmbientFrigatesOnInfested;
        [NMS(Index = 53)]
        /* 0x35D6 */ public bool ForceStartSystemAbandoned;
        [NMS(Index = 52)]
        /* 0x35D7 */ public bool ForceStartSystemTernary;
        [NMS(Index = 102)]
        /* 0x35D8 */ public bool HasBeenConverted;
        [NMS(Index = 91)]
        /* 0x35D9 */ public bool IncreaseXClassTechOddsWithCommTier;
        [NMS(Index = 37)]
        /* 0x35DA */ public bool MustCraftInBases;
        [NMS(Index = 99)]
        /* 0x35DB */ public bool ResetSaveOnDeath;
        [NMS(Index = 72)]
        /* 0x35DC */ public bool SandwormGlobalOverride;
        [NMS(Index = 76)]
        /* 0x35DD */ public bool ShipIsAtDifferentBuildingToPlayer;
        [NMS(Index = 79)]
        /* 0x35DE */ public bool ShipStartsDamaged;
        [NMS(Index = 51)]
        /* 0x35DF */ public bool StartAboardFreighter;
        [NMS(Index = 75)]
        /* 0x35E0 */ public bool StartNextToShip;
        [NMS(Index = 48)]
        /* 0x35E1 */ public bool StartWithFreighter;
        [NMS(Index = 85)]
        /* 0x35E2 */ public bool TrashInventoryOnGalaxyTravel;
        [NMS(Index = 60)]
        /* 0x35E3 */ public bool UseDefaultAppearance;
        [NMS(Index = 67)]
        /* 0x35E4 */ public bool UseRandomPet;
        [NMS(Index = 107)]
        /* 0x35E5 */ public bool UseSeasonalUAStationTradeData;
        [NMS(Index = 83)]
        /* 0x35E6 */ public bool UseStartPlanetObjectListOverrides;
    }
}
