...
{
    [NMS(GUID = 0x4B669BEA18A49247, NameHash = 0x35D4E04)]
    public class GcAlienPuzzleEntry : NMSTemplate
    {
        ...
        [NMS(Index = 12)]
        /* 0x10D */ public bool ForceLongTextSplitting;
        [NMS(Index = 13)]
        /* 0x10E */ public bool ProgressiveDialogue;
        [NMS(Index = 23)]
        /* 0x10F */ public bool RadialInteraction;
        [NMS(Index = 10)]
        /* 0x110 */ public bool TranslateAlienText;
        [NMS(Index = 11)]
        /* 0x111 */ public bool TranslationBrackets;
        [NMS(Index = 24)]
        /* 0x112 */ public bool UseTitleOverrideInLabel;
    }
}
