...
{
    [NMS(GUID = 0x72EA91537565B579, NameHash = 0xCD2E438C)]
    public class GcFleetGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 57)]
        /* 0x1278 */ public float RadiusRequiredForFrigateSpawn;
        [NMS(Index = 48)]
        /* 0x127C */ public int RampDamageNumberOfExpeditions;
        [NMS(Index = 4)]
        /* 0x1280 */ public float SingleShipFlybyDistance;
        [NMS(Index = 6)]
        /* 0x1284 */ public float SingleShipFlybyHeightOffset;
        [NMS(Index = 5)]
        /* 0x1288 */ public float SingleShipFlybyMaxAngle;
        [NMS(Index = 59)]
        /* 0x128C */ public float SpawnDelayForFleetFrigates;
        [NMS(Index = 58)]
        /* 0x1290 */ public float SpawnDelayForNewFrigates;
        [NMS(Index = 60)]
        /* 0x1294 */ public float SpawnDelayForReturningFrigates;
        [NMS(Index = 63)]
        /* 0x1298 */ public float SpawnDelayIncreasePerFrigate;
        [NMS(Index = 62)]
        /* 0x129C */ public float SpawnDelayRandomMax;
        [NMS(Index = 61)]
        /* 0x12A0 */ public float SpawnDelayRandomMin;
        [NMS(Index = 104)]
        /* 0x12A4 */ public int StatPointsAwardedForLevelUp;
        [NMS(Index = 110)]
        /* 0x12A8 */ public float TimeBeforeDebriefLogsStart;
        [NMS(Index = 33)]
        /* 0x12AC */ public float TimeBeforeHidingHangar;
        [NMS(Index = 44)]
        /* 0x12B0 */ public float TimeBeforePlayerAlertedToDamagedFrigates;
        [NMS(Index = 100)]
        /* 0x12B4 */ public float TimeBeforePlayerAlertedToInterventionEvent;
        [NMS(Index = 32)]
        /* 0x12B8 */ public float TimeBeforeShowingHangar;
        [NMS(Index = 107)]
        /* 0x12BC */ public float TimeBetweenDebriefLettersAppearing;
        [NMS(Index = 109)]
        /* 0x12C0 */ public float TimeBetweenDebriefLogsAppearing;
        [NMS(Index = 108)]
        /* 0x12C4 */ public float TimeBetweenDebriefLogSectionsAppearing;
        [NMS(Index = 93)]
        /* 0x12C8 */ public int TimeBetweenPassiveIncomeTicks;
        [NMS(Index = 89)]
        /* 0x12CC */ public int TimeTakenForExpeditionEvent;
        [NMS(Index = 88)]
        /* 0x12D0 */ public int TimeTakenForExpeditionEvent_Easy;
        [NMS(Index = 29)]
        /* 0x12D4 */ public float UITraitLinesAngle;
        [NMS(Index = 31, Size = 0x9, EnumType = typeof(GcAlienRace.AlienRaceEnum))]
        /* 0x12D8 */ public NMSString0x20[] RacialTermForCaptain;
        [NMS(Index = 39)]
        /* 0x13F8 */ public bool DisablePlayerFleets;
        [NMS(Index = 36)]
        /* 0x13F9 */ public bool ExpeditionsCompleteInstantly;
        [NMS(Index = 35)]
        /* 0x13FA */ public bool NewFrigatesStartDamaged;
        [NMS(Index = 111)]
        /* 0x13FB */ public bool ShowMissingRewardDescriptions;
        [NMS(Index = 38)]
        /* 0x13FC */ public bool ShowSeeds;
    }
}
