...
{
    [NMS(GUID = 0x4C263B506D5DFE1, NameHash = 0x2524086B)]
    public class GcGameplayGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 112, Size = 0x4, EnumType = typeof(GcInventoryClass.InventoryClassEnum))]
        ...
        [NMS(Index = 312, Size = 0x4, EnumType = typeof(GcPlayerConflictData.ConflictLevelEnum))]
        ...
        [NMS(Index = 108)]
        /* 0x1ACC */ public float SpecialShipSalvageNaniteCostMul;
        [NMS(Index = 40)]
        /* 0x1AD0 */ public float SpecialTechSlotBonus;
        [NMS(Index = 539)]
        /* 0x1AD4 */ public float SpeedReadoutMultiplier;
        [NMS(Index = 4)]
        /* 0x1AD8 */ public float SpookMessageChance;
        [NMS(Index = 5)]
        /* 0x1ADC */ public float SpookMessageCooldown;
        [NMS(Index = 3)]
        /* 0x1AE0 */ public float SpookMessageThreshold;
        [NMS(Index = 88)]
        /* 0x1AE4 */ public float StormBonusJetpackMod;
        [NMS(Index = 92)]
        /* 0x1AE8 */ public GcPlayerHazardType StormBonusJetpackWeather;
        [NMS(Index = 91)]
        /* 0x1AEC */ public float StormBonusMiningAmountMod;
        [NMS(Index = 95)]
        /* 0x1AF0 */ public GcPlayerHazardType StormBonusMiningAmountWeather;
        [NMS(Index = 90)]
        /* 0x1AF4 */ public float StormBonusMiningHeatMod;
        [NMS(Index = 94)]
        /* 0x1AF8 */ public GcPlayerHazardType StormBonusMiningHeatWeather;
        [NMS(Index = 89)]
        /* 0x1AFC */ public float StormBonusSprintMod;
        [NMS(Index = 93)]
        /* 0x1B00 */ public GcPlayerHazardType StormBonusSprintWeather;
        [NMS(Index = 87)]
        /* 0x1B04 */ public float StormGravityChangeTime;
        [NMS(Index = 618)]
        /* 0x1B08 */ public int SubstanceItemStockDecayTime;
        [NMS(Index = 619)]
        /* 0x1B0C */ public int SubstanceItemStockReplenishTime;
        [NMS(Index = 665)]
        /* 0x1B10 */ public float SunDamageExponent;
        [NMS(Index = 664)]
        /* 0x1B14 */ public float SunDamageFullDistanceScale;
        [NMS(Index = 666)]
        /* 0x1B18 */ public float SunDamageInterval;
        [NMS(Index = 663)]
        /* 0x1B1C */ public float SunDamageStartDistanceScale;
        [NMS(Index = 154)]
        /* 0x1B20 */ public float SurveyBeginScanPercentage;
        [NMS(Index = 162)]
        /* 0x1B24 */ public float SurveyMaxDistance;
        [NMS(Index = 156)]
        /* 0x1B28 */ public float SurveyScanMaxSpeed;
        [NMS(Index = 155)]
        /* 0x1B2C */ public float SurveyScanMinSpeed;
        [NMS(Index = 159)]
        /* 0x1B30 */ public float SurveySonarMaxPulseSpeed;
        [NMS(Index = 161)]
        /* 0x1B34 */ public float SurveySonarMiddleRangeMax;
        [NMS(Index = 160)]
        /* 0x1B38 */ public float SurveySonarMiddleRangeMin;
        [NMS(Index = 158)]
        /* 0x1B3C */ public float SurveySonarMinPulseSpeed;
        [NMS(Index = 157)]
        /* 0x1B40 */ public float SurveySonarPulseSpeedBandCount;
        [NMS(Index = 252)]
        /* 0x1B44 */ public float TapInteractionDecay;
        [NMS(Index = 251)]
        /* 0x1B48 */ public float TapInteractionIncreaseAmount;
        [NMS(Index = 45)]
        /* 0x1B4C */ public float TechDamageChanceShieldedMax;
        [NMS(Index = 47)]
        /* 0x1B50 */ public float TechDamageChanceShieldLevelMax;
        [NMS(Index = 46)]
        /* 0x1B54 */ public float TechDamageChanceShieldLevelMin;
        [NMS(Index = 48)]
        /* 0x1B58 */ public float TechDamageChanceToSelectPrimary;
        [NMS(Index = 85)]
        /* 0x1B5C */ public GcTechnologyCategory TechnologyOverrideForSmuggler;
        [NMS(Index = 123)]
        /* 0x1B60 */ public float TeleporterDistanceTravelledMultiplier;
        [NMS(Index = 225)]
        /* 0x1B64 */ public float TerrainResourceCompassRange;
        [NMS(Index = 224)]
        /* 0x1B68 */ public float TerrainResourceDrainRemainingFraction;
        [NMS(Index = 223)]
        /* 0x1B6C */ public float TerrainResourceScanRange;
        [NMS(Index = 222)]
        /* 0x1B70 */ public float TerrainResourceScanTime;
        [NMS(Index = 419)]
        /* 0x1B74 */ public float TimeToDisplayScanResults;
        [NMS(Index = 542)]
        /* 0x1B78 */ public int TorchCookieIndex;
        [NMS(Index = 545)]
        /* 0x1B7C */ public int TorchDimCookieIndex;
        [NMS(Index = 546)]
        /* 0x1B80 */ public float TorchDimFoV;
        [NMS(Index = 547)]
        /* 0x1B84 */ public float TorchDimStrength;
        [NMS(Index = 570)]
        /* 0x1B88 */ public float TorchFollowCameraPitch;
        [NMS(Index = 571)]
        /* 0x1B8C */ public float TorchFollowCameraTime;
        [NMS(Index = 543)]
        /* 0x1B90 */ public float TorchFoV;
        [NMS(Index = 565)]
        /* 0x1B94 */ public float TorchHandOffsetX;
        [NMS(Index = 566)]
        /* 0x1B98 */ public float TorchHandOffsetY;
        [NMS(Index = 567)]
        /* 0x1B9C */ public float TorchHandOffsetZ;
        [NMS(Index = 556)]
        /* 0x1BA0 */ public float TorchOffsetX;
        [NMS(Index = 557)]
        /* 0x1BA4 */ public float TorchOffsetY;
        [NMS(Index = 559)]
        /* 0x1BA8 */ public float TorchOffsetZ;
        [NMS(Index = 558)]
        /* 0x1BAC */ public float TorchOffsetZMin;
        [NMS(Index = 564)]
        /* 0x1BB0 */ public float TorchOffsetZMinSpeed;
        [NMS(Index = 563)]
        /* 0x1BB4 */ public float TorchOffsetZSpeedRange;
        [NMS(Index = 569)]
        /* 0x1BB8 */ public float TorchRotation;
        [NMS(Index = 560)]
        /* 0x1BBC */ public float TorchStaffOffsetY;
        [NMS(Index = 562)]
        /* 0x1BC0 */ public float TorchStaffOffsetZ;
        [NMS(Index = 561)]
        /* 0x1BC4 */ public float TorchStaffOffsetZMin;
        [NMS(Index = 544)]
        /* 0x1BC8 */ public float TorchStrength;
        [NMS(Index = 117)]
        /* 0x1BCC */ public float TorpedoCooldown;
        [NMS(Index = 120)]
        /* 0x1BD0 */ public float TorpedoCooldownRandomExtra;
        [NMS(Index = 119)]
        /* 0x1BD4 */ public float TorpedoInitialWait;
        [NMS(Index = 121)]
        /* 0x1BD8 */ public float TorpedoLaunchWarning;
        [NMS(Index = 384)]
        /* 0x1BDC */ public int TunnelStatReducer;
        [NMS(Index = 23)]
        /* 0x1BE0 */ public float TurretAITargetingDistanceFactor;
        [NMS(Index = 27)]
        /* 0x1BE4 */ public float TurretAITargetingFocusPlayerFactor;
        [NMS(Index = 26)]
        /* 0x1BE8 */ public float TurretAITargetingLastHitFactor;
        [NMS(Index = 24)]
        /* 0x1BEC */ public float TurretAITargetingPitchAngleFactor;
        [NMS(Index = 25)]
        /* 0x1BF0 */ public float TurretAITargetingYawAngleFactor;
        [NMS(Index = 550)]
        /* 0x1BF4 */ public float UndergroundTorchFoV;
        [NMS(Index = 551)]
        /* 0x1BF8 */ public float UndergroundTorchStrength;
        [NMS(Index = 554)]
        /* 0x1BFC */ public float UnderwaterAmbientLightStrength;
        [NMS(Index = 81)]
        /* 0x1C00 */ public float UnderwaterLightningDamageDistanceMultiplier;
        [NMS(Index = 552)]
        /* 0x1C04 */ public float UnderwaterTorchFoV;
        [NMS(Index = 553)]
        /* 0x1C08 */ public float UnderwaterTorchStrengthMax;
        [NMS(Index = 555)]
        /* 0x1C0C */ public float UnderwaterTorchVolumetricStrength;
        [NMS(Index = 101)]
        /* 0x1C10 */ public float VehicleAllIconScanTime;
        [NMS(Index = 688)]
        /* 0x1C14 */ public int VehicleInventoryMinHeightMax;
        [NMS(Index = 687)]
        /* 0x1C18 */ public int VehicleInventoryMinWidthMax;
        [NMS(Index = 627)]
        /* 0x1C1C */ public float ViciousSentinelProbability;
        [NMS(Index = 628)]
        /* 0x1C20 */ public float ViciousStormProbability;
        [NMS(Index = 629)]
        /* 0x1C24 */ public float ViciousWeatherProbability;
        [NMS(Index = 385)]
        /* 0x1C28 */ public float VoxelAsteroidResourceChance;
        [NMS(Index = 303)]
        /* 0x1C2C */ public int WarpsBetweenBattles;
        [NMS(Index = 601)]
        /* 0x1C30 */ public int WarpsBetweenMiniStation;
        [NMS(Index = 340)]
        /* 0x1C34 */ public float WaterLandingDamageMultiplier;
        [NMS(Index = 379)]
        /* 0x1C38 */ public float WaypointScanTime;
        [NMS(Index = 690)]
        /* 0x1C3C */ public int WeaponInventoryMinHeightMax;
        [NMS(Index = 689)]
        /* 0x1C40 */ public int WeaponInventoryMinWidthMax;
        [NMS(Index = 84)]
        /* 0x1C44 */ public float WeatherHazardGiftLifeTime;
        [NMS(Index = 83)]
        /* 0x1C48 */ public float WeatherHazardGiftMaxDistance;
        [NMS(Index = 418)]
        /* 0x1C4C */ public float ZoomFindBuildingRange;
        [NMS(Index = 401)]
        /* 0x1C50 */ public NMSString0x20 DepotResource;
        [NMS(Index = 400)]
        /* 0x1C70 */ public NMSString0x20 RobotResource;
        [NMS(Index = 199)]
        /* 0x1C90 */ public bool AllowBinocularMarker;
        [NMS(Index = 198)]
        /* 0x1C91 */ public bool AllowDeconstruct;
        [NMS(Index = 168)]
        /* 0x1C92 */ public bool AllowSpaceScanEvents;
        [NMS(Index = 214)]
        /* 0x1C93 */ public TkCurveType AtmosphereEntryCurve;
        [NMS(Index = 467)]
        /* 0x1C94 */ public bool Autolevel;
        [NMS(Index = 226)]
        /* 0x1C95 */ public bool BinocsDisplayUnknownCreatures;
        [NMS(Index = 233)]
        /* 0x1C96 */ public TkCurveType BinocularScanTargetHeightCurve;
        [NMS(Index = 169)]
        /* 0x1C97 */ public bool CanMoveTechnology;
        [NMS(Index = 614)]
        /* 0x1C98 */ public bool ChangePricesLocally;
        [NMS(Index = 538)]
        /* 0x1C99 */ public bool DebugDrawTriggerBoxes;
        [NMS(Index = 39)]
        /* 0x1C9A */ public bool DebugPrintShootables;
        [NMS(Index = 449)]
        /* 0x1C9B */ public bool DebugScanForceBuilding;
        [NMS(Index = 450)]
        /* 0x1C9C */ public GcBuildingClassification DebugScanForceBuildingType;
        [NMS(Index = 197)]
        /* 0x1C9D */ public bool DisableAnomalyAmbientSpawn;
        [NMS(Index = 609)]
        /* 0x1C9E */ public bool DisableBasePowerHUDOverlay;
        [NMS(Index = 165)]
        /* 0x1C9F */ public bool DisableGalaxyMapInQuickMenu;
        [NMS(Index = 166)]
        /* 0x1CA0 */ public bool DisableNexusInQuickMenu;
        [NMS(Index = 202)]
        /* 0x1CA1 */ public bool EnableShootHitEffect;
        [NMS(Index = 43)]
        /* 0x1CA2 */ public bool EnableTechPackaging;
        [NMS(Index = 167)]
        /* 0x1CA3 */ public bool EnableTeleporters;
        [NMS(Index = 200)]
        /* 0x1CA4 */ public bool EveryMaintenanceIsBroken;
        [NMS(Index = 339)]
        /* 0x1CA5 */ public bool FailToFindBuildings;
        [NMS(Index = 196)]
        /* 0x1CA6 */ public bool FreighterRequiresRGBHyperdriveUpgrades;
        [NMS(Index = 481)]
        /* 0x1CA7 */ public bool HUDUpdateFromData;
        [NMS(Index = 195)]
        /* 0x1CA8 */ public bool InstallTechWithInteraction;
        [NMS(Index = 279)]
        /* 0x1CA9 */ public bool InteractionOverride;
        [NMS(Index = 610)]
        /* 0x1CAA */ public bool KeepAttackingMaxWantedLevel;
        [NMS(Index = 132)]
        /* 0x1CAB */ public bool MissionSurveySuggestSurveyForNearScannables;
        [NMS(Index = 184)]
        /* 0x1CAC */ public TkCurveType OverheatColourCurve;
        [NMS(Index = 183)]
        /* 0x1CAD */ public TkCurveType OverheatColourCurveShip;
        [NMS(Index = 179)]
        /* 0x1CAE */ public TkCurveType OverheatCurve;
        [NMS(Index = 523)]
        /* 0x1CAF */ public TkCurveType PainCurve;
        [NMS(Index = 499)]
        /* 0x1CB0 */ public bool PlayHitEffectsOnZeroDamage;
        [NMS(Index = 14)]
        /* 0x1CB1 */ public bool RewardInventoryClassItemFromShipSalvage;
        [NMS(Index = 29)]
        /* 0x1CB2 */ public bool ScanToRevealIgnoreRequirements;
        [NMS(Index = 30)]
        /* 0x1CB3 */ public bool ScanToRevealNPCsAlwaysTriggersCameraEvent;
        [NMS(Index = 453)]
        /* 0x1CB4 */ public TkCurveType ShipScanCurve;
        [NMS(Index = 615)]
        /* 0x1CB5 */ public bool ShowPriceMarkupsAsPercentages;
        [NMS(Index = 201)]
        /* 0x1CB6 */ public bool SpawnResourceBlobsOnPartDelete;
        [NMS(Index = 38)]
        /* 0x1CB7 */ public bool TechMustBeInTechInventory;
        [NMS(Index = 568)]
        /* 0x1CB8 */ public bool TorchDisabledInTheDay;
        [NMS(Index = 677)]
        /* 0x1CB9 */ public bool UseCustomSaveDirectory;
        [NMS(Index = 448)]
        /* 0x1CBA */ public bool UseDebugScan;
        [NMS(Index = 611)]
        /* 0x1CBB */ public bool UseMultiplierBonus;
        [NMS(Index = 180)]
        /* 0x1CBC */ public bool UseOverheatColour;
        [NMS(Index = 37)]
        /* 0x1CBD */ public bool UseSecondaryBiomeSubstances;
        [NMS(Index = 613)]
        /* 0x1CBE */ public bool UseTradingCostTable;
    }
}
