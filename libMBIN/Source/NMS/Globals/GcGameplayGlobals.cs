...
{
    [NMS(GUID = 0xF33F3B6BD39F7462, NameHash = 0x2524086B)]
    public class GcGameplayGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 648, Size = 0x8)]
        /* 0x11E4 */ public int[] AlienShipEvolveCosts;
        [NMS(Index = 364)]
        /* 0x1204 */ public GcExperienceTimers FlybyTimers;
        [NMS(Index = 367, Size = 0x8, EnumType = typeof(GcProceduralTechnologyData.QualityEnum))]
        ...
        [NMS(Index = 310, Size = 0x4, EnumType = typeof(GcPlayerConflictData.ConflictLevelEnum))]
        /* 0x1354 */ public float[] ChanceOfPirateFreighterBattleOnWarpToSystem;
        [NMS(Index = 31, Size = 0x3, EnumType = typeof(GcMissionDifficulty.MissionDifficultyEnum))]
        ...
        [NMS(Index = 82)]
        /* 0x1A3C */ public float StormBonusJetpackMod;
        [NMS(Index = 86)]
        /* 0x1A40 */ public GcPlayerHazardType StormBonusJetpackWeather;
        [NMS(Index = 85)]
        /* 0x1A44 */ public float StormBonusMiningAmountMod;
        [NMS(Index = 89)]
        /* 0x1A48 */ public GcPlayerHazardType StormBonusMiningAmountWeather;
        [NMS(Index = 84)]
        /* 0x1A4C */ public float StormBonusMiningHeatMod;
        [NMS(Index = 88)]
        /* 0x1A50 */ public GcPlayerHazardType StormBonusMiningHeatWeather;
        [NMS(Index = 83)]
        /* 0x1A54 */ public float StormBonusSprintMod;
        [NMS(Index = 87)]
        /* 0x1A58 */ public GcPlayerHazardType StormBonusSprintWeather;
        [NMS(Index = 81)]
        /* 0x1A5C */ public float StormGravityChangeTime;
        [NMS(Index = 608)]
        /* 0x1A60 */ public int SubstanceItemStockDecayTime;
        [NMS(Index = 609)]
        /* 0x1A64 */ public int SubstanceItemStockReplenishTime;
        [NMS(Index = 148)]
        /* 0x1A68 */ public float SurveyBeginScanPercentage;
        [NMS(Index = 156)]
        /* 0x1A6C */ public float SurveyMaxDistance;
        [NMS(Index = 150)]
        /* 0x1A70 */ public float SurveyScanMaxSpeed;
        [NMS(Index = 149)]
        /* 0x1A74 */ public float SurveyScanMinSpeed;
        [NMS(Index = 153)]
        /* 0x1A78 */ public float SurveySonarMaxPulseSpeed;
        [NMS(Index = 155)]
        /* 0x1A7C */ public float SurveySonarMiddleRangeMax;
        [NMS(Index = 154)]
        /* 0x1A80 */ public float SurveySonarMiddleRangeMin;
        [NMS(Index = 152)]
        /* 0x1A84 */ public float SurveySonarMinPulseSpeed;
        [NMS(Index = 151)]
        /* 0x1A88 */ public float SurveySonarPulseSpeedBandCount;
        [NMS(Index = 242)]
        /* 0x1A8C */ public float TapInteractionDecay;
        [NMS(Index = 241)]
        /* 0x1A90 */ public float TapInteractionIncreaseAmount;
        [NMS(Index = 39)]
        /* 0x1A94 */ public float TechDamageChanceShieldedMax;
        [NMS(Index = 41)]
        /* 0x1A98 */ public float TechDamageChanceShieldLevelMax;
        [NMS(Index = 40)]
        /* 0x1A9C */ public float TechDamageChanceShieldLevelMin;
        [NMS(Index = 42)]
        /* 0x1AA0 */ public float TechDamageChanceToSelectPrimary;
        [NMS(Index = 79)]
        /* 0x1AA4 */ public GcTechnologyCategory TechnologyOverrideForSmuggler;
        [NMS(Index = 117)]
        /* 0x1AA8 */ public float TeleporterDistanceTravelledMultiplier;
        [NMS(Index = 215)]
        /* 0x1AAC */ public float TerrainResourceCompassRange;
        [NMS(Index = 214)]
        /* 0x1AB0 */ public float TerrainResourceScanRange;
        [NMS(Index = 213)]
        /* 0x1AB4 */ public float TerrainResourceScanTime;
        [NMS(Index = 414)]
        /* 0x1AB8 */ public float TimeToDisplayScanResults;
        [NMS(Index = 537)]
        /* 0x1ABC */ public int TorchCookieIndex;
        [NMS(Index = 540)]
        /* 0x1AC0 */ public int TorchDimCookieIndex;
        [NMS(Index = 541)]
        /* 0x1AC4 */ public float TorchDimFoV;
        [NMS(Index = 542)]
        /* 0x1AC8 */ public float TorchDimStrength;
        [NMS(Index = 563)]
        /* 0x1ACC */ public float TorchFollowCameraPitch;
        [NMS(Index = 564)]
        /* 0x1AD0 */ public float TorchFollowCameraTime;
        [NMS(Index = 538)]
        /* 0x1AD4 */ public float TorchFoV;
        [NMS(Index = 558)]
        /* 0x1AD8 */ public float TorchHandOffsetX;
        [NMS(Index = 559)]
        /* 0x1ADC */ public float TorchHandOffsetY;
        [NMS(Index = 560)]
        /* 0x1AE0 */ public float TorchHandOffsetZ;
        [NMS(Index = 549)]
        /* 0x1AE4 */ public float TorchOffsetX;
        [NMS(Index = 550)]
        /* 0x1AE8 */ public float TorchOffsetY;
        [NMS(Index = 552)]
        /* 0x1AEC */ public float TorchOffsetZ;
        [NMS(Index = 551)]
        /* 0x1AF0 */ public float TorchOffsetZMin;
        [NMS(Index = 557)]
        /* 0x1AF4 */ public float TorchOffsetZMinSpeed;
        [NMS(Index = 556)]
        /* 0x1AF8 */ public float TorchOffsetZSpeedRange;
        [NMS(Index = 562)]
        /* 0x1AFC */ public float TorchRotation;
        [NMS(Index = 553)]
        /* 0x1B00 */ public float TorchStaffOffsetY;
        [NMS(Index = 555)]
        /* 0x1B04 */ public float TorchStaffOffsetZ;
        [NMS(Index = 554)]
        /* 0x1B08 */ public float TorchStaffOffsetZMin;
        [NMS(Index = 539)]
        /* 0x1B0C */ public float TorchStrength;
        [NMS(Index = 110)]
        /* 0x1B10 */ public float TorpedoCooldown;
        [NMS(Index = 114)]
        /* 0x1B14 */ public float TorpedoCooldownRandomExtra;
        [NMS(Index = 113)]
        /* 0x1B18 */ public float TorpedoInitialWait;
        [NMS(Index = 115)]
        /* 0x1B1C */ public float TorpedoLaunchWarning;
        [NMS(Index = 381)]
        /* 0x1B20 */ public int TunnelStatReducer;
        [NMS(Index = 18)]
        /* 0x1B24 */ public float TurretAITargetingDistanceFactor;
        [NMS(Index = 22)]
        /* 0x1B28 */ public float TurretAITargetingFocusPlayerFactor;
        [NMS(Index = 21)]
        /* 0x1B2C */ public float TurretAITargetingLastHitFactor;
        [NMS(Index = 19)]
        /* 0x1B30 */ public float TurretAITargetingPitchAngleFactor;
        [NMS(Index = 20)]
        /* 0x1B34 */ public float TurretAITargetingYawAngleFactor;
        [NMS(Index = 545)]
        /* 0x1B38 */ public float UndergroundTorchFoV;
        [NMS(Index = 546)]
        /* 0x1B3C */ public float UndergroundTorchFoVFar;
        [NMS(Index = 547)]
        /* 0x1B40 */ public float UndergroundTorchStrength;
        [NMS(Index = 548)]
        /* 0x1B44 */ public float UndergroundTorchStrengthFar;
        [NMS(Index = 75)]
        /* 0x1B48 */ public float UnderwaterLightningDamageDistanceMultiplier;
        [NMS(Index = 95)]
        /* 0x1B4C */ public float VehicleAllIconScanTime;
        [NMS(Index = 663)]
        /* 0x1B50 */ public int VehicleInventoryMinHeightMax;
        [NMS(Index = 662)]
        /* 0x1B54 */ public int VehicleInventoryMinWidthMax;
        [NMS(Index = 615)]
        /* 0x1B58 */ public float ViciousSentinelProbability;
        [NMS(Index = 616)]
        /* 0x1B5C */ public float ViciousStormProbability;
        [NMS(Index = 617)]
        /* 0x1B60 */ public float ViciousWeatherProbability;
        [NMS(Index = 382)]
        /* 0x1B64 */ public float VoxelAsteroidResourceChance;
        [NMS(Index = 293)]
        /* 0x1B68 */ public int WarpsBetweenBattles;
        [NMS(Index = 591)]
        /* 0x1B6C */ public int WarpsBetweenMiniStation;
        [NMS(Index = 338)]
        /* 0x1B70 */ public float WaterLandingDamageMultiplier;
        [NMS(Index = 376)]
        /* 0x1B74 */ public float WaypointScanTime;
        [NMS(Index = 665)]
        /* 0x1B78 */ public int WeaponInventoryMinHeightMax;
        [NMS(Index = 664)]
        /* 0x1B7C */ public int WeaponInventoryMinWidthMax;
        [NMS(Index = 78)]
        /* 0x1B80 */ public float WeatherHazardGiftLifeTime;
        [NMS(Index = 77)]
        /* 0x1B84 */ public float WeatherHazardGiftMaxDistance;
        [NMS(Index = 413)]
        /* 0x1B88 */ public float ZoomFindBuildingRange;
        [NMS(Index = 396)]
        /* 0x1B8C */ public NMSString0x20 DepotResource;
        [NMS(Index = 395)]
        /* 0x1BAC */ public NMSString0x20 RobotResource;
        [NMS(Index = 193)]
        /* 0x1BCC */ public bool AllowBinocularMarker;
        [NMS(Index = 192)]
        /* 0x1BCD */ public bool AllowDeconstruct;
        [NMS(Index = 162)]
        /* 0x1BCE */ public bool AllowSpaceScanEvents;
        [NMS(Index = 208)]
        /* 0x1BCF */ public TkCurveType AtmosphereEntryCurve;
        [NMS(Index = 462)]
        /* 0x1BD0 */ public bool Autolevel;
        [NMS(Index = 216)]
        /* 0x1BD1 */ public bool BinocsDisplayUnknownCreatures;
        [NMS(Index = 223)]
        /* 0x1BD2 */ public TkCurveType BinocularScanTargetHeightCurve;
        [NMS(Index = 163)]
        /* 0x1BD3 */ public bool CanMoveTechnology;
        [NMS(Index = 604)]
        /* 0x1BD4 */ public bool ChangePricesLocally;
        [NMS(Index = 533)]
        /* 0x1BD5 */ public bool DebugDrawTriggerBoxes;
        [NMS(Index = 34)]
        /* 0x1BD6 */ public bool DebugPrintShootables;
        [NMS(Index = 444)]
        /* 0x1BD7 */ public bool DebugScanForceBuilding;
        [NMS(Index = 191)]
        /* 0x1BD8 */ public bool DisableAnomalyAmbientSpawn;
        [NMS(Index = 599)]
        /* 0x1BD9 */ public bool DisableBasePowerHUDOverlay;
        [NMS(Index = 159)]
        /* 0x1BDA */ public bool DisableGalaxyMapInQuickMenu;
        [NMS(Index = 160)]
        /* 0x1BDB */ public bool DisableNexusInQuickMenu;
        [NMS(Index = 4)]
        /* 0x1BDC */ public bool DoShipBuilderInteractionBuildEffect;
        [NMS(Index = 7)]
        /* 0x1BDD */ public bool DoShipBuilderInteractionBuildEffectOutward;
        [NMS(Index = 196)]
        /* 0x1BDE */ public bool EnableShootHitEffect;
        [NMS(Index = 37)]
        /* 0x1BDF */ public bool EnableTechPackaging;
        [NMS(Index = 161)]
        /* 0x1BE0 */ public bool EnableTeleporters;
        [NMS(Index = 194)]
        /* 0x1BE1 */ public bool EveryMaintenanceIsBroken;
        [NMS(Index = 337)]
        /* 0x1BE2 */ public bool FailToFindBuildings;
        [NMS(Index = 190)]
        /* 0x1BE3 */ public bool FreighterRequiresRGBHyperdriveUpgrades;
        [NMS(Index = 476)]
        /* 0x1BE4 */ public bool HUDUpdateFromData;
        [NMS(Index = 189)]
        /* 0x1BE5 */ public bool InstallTechWithInteraction;
        [NMS(Index = 269)]
        /* 0x1BE6 */ public bool InteractionOverride;
        [NMS(Index = 600)]
        /* 0x1BE7 */ public bool KeepAttackingMaxWantedLevel;
        [NMS(Index = 126)]
        /* 0x1BE8 */ public bool MissionSurveySuggestSurveyForNearScannables;
        [NMS(Index = 178)]
        /* 0x1BE9 */ public TkCurveType OverheatColourCurve;
        [NMS(Index = 177)]
        /* 0x1BEA */ public TkCurveType OverheatColourCurveShip;
        [NMS(Index = 173)]
        /* 0x1BEB */ public TkCurveType OverheatCurve;
        [NMS(Index = 518)]
        /* 0x1BEC */ public TkCurveType PainCurve;
        [NMS(Index = 494)]
        /* 0x1BED */ public bool PlayHitEffectsOnZeroDamage;
        [NMS(Index = 9)]
        /* 0x1BEE */ public bool RewardInventoryClassItemFromShipSalvage;
        [NMS(Index = 24)]
        /* 0x1BEF */ public bool ScanToRevealIgnoreRequirements;
        [NMS(Index = 25)]
        /* 0x1BF0 */ public bool ScanToRevealNPCsAlwaysTriggersCameraEvent;
        [NMS(Index = 448)]
        /* 0x1BF1 */ public TkCurveType ShipScanCurve;
        [NMS(Index = 605)]
        /* 0x1BF2 */ public bool ShowPriceMarkupsAsPercentages;
        [NMS(Index = 195)]
        /* 0x1BF3 */ public bool SpawnResourceBlobsOnPartDelete;
        [NMS(Index = 33)]
        /* 0x1BF4 */ public bool TechMustBeInTechInventory;
        [NMS(Index = 561)]
        /* 0x1BF5 */ public bool TorchDisabledInTheDay;
        [NMS(Index = 652)]
        /* 0x1BF6 */ public bool UseCustomSaveDirectory;
        [NMS(Index = 443)]
        /* 0x1BF7 */ public bool UseDebugScan;
        [NMS(Index = 601)]
        /* 0x1BF8 */ public bool UseMultiplierBonus;
        [NMS(Index = 174)]
        /* 0x1BF9 */ public bool UseOverheatColour;
        [NMS(Index = 32)]
        /* 0x1BFA */ public bool UseSecondaryBiomeSubstances;
        [NMS(Index = 603)]
        /* 0x1BFB */ public bool UseTradingCostTable;
    }
}
