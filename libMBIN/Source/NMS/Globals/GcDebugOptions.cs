...
{
    [NMS(Size = 0x2570, GUID = 0x93DEEA949C98F6D6, NameHash = 0x013FED27DF728C38)]
    public class GcDebugOptions : NMSTemplate
    {
        ...
        /* 0x1E78 */ public int ProceduralModelFilterMatchretryCount;
        /* 0x1E7C */ public bool ProceduralModelsDeterministicSequence;
        /* 0x1E80 */ public int ProceduralModelsThumbnailSize;
        /* 0x1E84 */ public NMSString0x80 DebugFont;
        /* 0x1F04 */ public NMSString0x80 DebugFontTexture;
        /* 0x1F84 */ public NMSString0x80 CursorTexture;
        /* 0x2004 */ public NMSString0x80 PauseTexture;
        /* 0x2084 */ public NMSString0x80 PlayTexture;
        /* 0x2104 */ public NMSString0x80 StepTexture;
        /* 0x2184 */ public NMSString0x80 RenderToTexture;
        /* 0x2204 */ public bool HmdEnable;
        /* 0x2208 */ public int HmdPreviewScale;
        /* 0x220C */ public bool HmdTracking;
        /* 0x220D */ public bool HmdStereoRender;
        /* 0x220E */ public bool HmdDistortionPassthru;
        /* 0x2210 */ public int HmdMonitor;
        /* 0x2214 */ public int HmdEyeBufferWidth;
        /* 0x2218 */ public int HmdEyeBufferHeight;
        /* 0x221C */ public float HmdEyeScalePos;
        /* 0x2220 */ public float HmdHeadScalePos;
        /* 0x2224 */ public bool HmdFrameShiftEnabled;
        /* 0x2225 */ public bool HmdUseSolidGuiPointer;
        /* 0x2226 */ public bool BodyTurning;
        /* 0x2228 */ public float HmdImmersionFactor;
        /* 0x222C */ public bool ShowHmdHandControllers;
        /* 0x222D */ public bool ShowTeleportEffectLocally;
        /* 0x222E */ public bool DisableLeftHand;
        /* 0x222F */ public bool DisableHeadConstraints;
        /* 0x2230 */ public bool EnablePhotomodeVR;
        /* 0x2231 */ public bool AllowNGuiVR;
        /* 0x2232 */ public bool ForceExtremeWeather;
        /* 0x2233 */ public bool ForceExtremeSentinels;
        /* 0x2234 */ public bool ForceStarType;
        /* 0x2235 */ public bool ForceLoadAllWeather;
        /* 0x2238 */ public GcGalaxyStarTypes ForceStarTypeTo;
        /* 0x223C */ public bool ForceBiome;
        /* 0x2240 */ public GcBiomeType ForceBiomeTo;
        /* 0x2244 */ public bool ForceScreenFilter;
        /* 0x2248 */ public GcScreenFilters ForceScreenFilterTo;
        /* 0x224C */ public GcBiomeSubType ForceBiomeSubTypeTo;
        /* 0x2250 */ public bool ForceBuildingRace;
        /* 0x2254 */ public GcAlienRace ForceBuildingRaceTo;
        /* 0x2258 */ public bool ForceLifeLevel;
        /* 0x225C */ public GcPlanetLife ForceLifeLevelTo;
        /* 0x2260 */ public bool ForceCreatureLifeLevel;
        /* 0x2251 */ public bool ForceDefaultCreatureFile;
        /* 0x2268 */ public NMSString0x10 DefaultGroundCreatureTable;
        /* 0x2278 */ public NMSString0x10 DefaultAirCreatureTable;
        /* 0x2288 */ public NMSString0x10 DefaultWaterCreatureTable;
        /* 0x2298 */ public NMSString0x10 DefaultCaveCreatureTable;
        /* 0x22A8 */ public GcPlanetLife ForceCreatureLifeLevelTo;
        /* 0x22AC */ public GcPlanetLife ForceTerrainSettings;
        /* 0x22B0 */ public bool ForceTerrainType;
        /* 0x22B4 */ public TkVoxelGeneratorSettingsTypes ForceTerrainTypeTo;
        /* 0x22B8 */ public bool ForcePrimeTerrain;
        /* 0x22B9 */ public bool ForceBinaryStar;
        /* 0x22BA */ public bool ForceTernaryStar;
        /* 0x22BC */ public GcGalaxyStarAnomaly ForceAnomalyTo;
        /* 0x22C0 */ public bool ForcePlanetsToHaveWater;
        /* 0x22C4 */ public int ForceWaterObjectFileIndex;
        /* 0x22C8 */ public int ForceSkyColourIndex;
        /* 0x22CC */ public int ForceWaterColourIndex;
        /* 0x22D0 */ public int ForceGrassColourIndex;
        /* 0x22D4 */ public bool ModifyPlanetsInInitialSystems;
        /* 0x22D5 */ public bool ForcePlanetsToHaveNoWater;
        /* 0x22D6 */ public bool ForcePlanetsToHaveNoCaves;
        /* 0x22D7 */ public bool ForcePlanetsToHaveNoNoiseLayers;
        /* 0x22D8 */ public bool ForcePlanetsToHaveNoTerrainFeatures;
        /* 0x22D9 */ public bool DisableLimits;
        /* 0x22DA */ public bool LimitPerRegionInstances;
        /* 0x22DB */ public bool LimitPerRegionBodies;
        /* 0x22DC */ public bool LimitGlobalInstances;
        /* 0x22DD */ public bool LimitGlobalBodies;
        /* 0x22E0 */ public int GenerateFarLodBuildingDist;
        /* 0x22E4 */ public bool DeferRegionBodies;
        /* 0x22E8 */ public float GenerateCostDistance;
        /* 0x22EC */ public float GenerateCostAngle;
        /* 0x22F0 */ public float GenerateCostLOD;
        /* 0x22F4 */ public float GenerateCostWait;
        /* 0x22F8 */ public bool DChecksEnabled;
        /* 0x22F9 */ public bool DChecksOutputJson;
        /* 0x22FA */ public bool DChecksOutputBinary;
        /* 0x22FB */ public bool DChecksOutputFileLine;
        /* 0x22FC */ public int FrameFlipRateDefault;
        /* 0x2300 */ public int FrameFlipRateLoad;
        /* 0x2304 */ public int FrameFlipRateGame;
        /* 0x2308 */ public float MaxFrameRate;
        /* 0x230C */ public bool DisableBaseBuilding;
        /* 0x230D */ public bool DisableBaseBuildingLimits;
        /* 0x230E */ public bool AllowGlobalPartSnapping;
        /* 0x2310 */ public float BaseDownloadTimeout;
        /* 0x2314 */ public bool DisableBasePowerRequirements;
        /* 0x2315 */ public bool EnableBaseMovingOption;
        /* 0x2318 */ public int MoveBaseIndex;
        /* 0x231C */ public int AutomaticPartSpawnIndex;
        /* 0x2320 */ public bool BaseAdmin;
        /* 0x2321 */ public NMSString0x20 BaseServerPlatform;       // "pc"
        /* 0x2344 */ public uint BasePayloadMultiplier;
