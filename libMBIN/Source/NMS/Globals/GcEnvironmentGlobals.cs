...
{
    [NMS(GUID = 0x9FE568770A623C6, NameHash = 0x5EAFF93E)]
    public class GcEnvironmentGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 42)]
        /* 0x5E4 */ public float ShipTemperature;
        [NMS(Index = 46)]
        /* 0x5E8 */ public float ShipToxicity;
        [NMS(Index = 95)]
        /* 0x5EC */ public float SkyAtmospherePower;
        [NMS(Index = 89)]
        /* 0x5F0 */ public float SmallAsteroidScale;
        [NMS(Index = 43)]
        /* 0x5F4 */ public float SpaceRadiation;
        [NMS(Index = 58)]
        /* 0x5F8 */ public float SpaceStationStateBoundingBoxScaler;
        [NMS(Index = 39)]
        /* 0x5FC */ public float SpaceTemperature;
        [NMS(Index = 45)]
        /* 0x600 */ public float SpaceToxicity;
        [NMS(Index = 60)]
        /* 0x604 */ public float SpawnLowerAtmosphereRadiusMultiplier;
        [NMS(Index = 20)]
        /* 0x608 */ public float SphereLodTextureScale;
        [NMS(Index = 77)]
        /* 0x60C */ public float SunClampHeightMax;
        [NMS(Index = 76)]
        /* 0x610 */ public float SunClampHeightMin;
        [NMS(Index = 33)]
        /* 0x614 */ public float SunFactorMin;
        // size: 0x3
        ...
        [NMS(Index = 49)]
        /* 0x618 */ public SwitchTypeEnum SwitchType;
        [NMS(Index = 32)]
        /* 0x61C */ public float TemperatureSmoothTime;
        [NMS(Index = 61)]
        /* 0x620 */ public float TerrainFadeTime;
        [NMS(Index = 62)]
        /* 0x624 */ public float TerrainFadeTimeInShip;
        [NMS(Index = 69)]
        /* 0x628 */ public float TerrainFlattenMax;
        [NMS(Index = 68)]
        /* 0x62C */ public float TerrainFlattenMin;
        [NMS(Index = 26)]
        /* 0x630 */ public float VDeform;
        [NMS(Index = 73)]
        /* 0x634 */ public float WaterAlphaHeightMax;
        [NMS(Index = 72)]
        /* 0x638 */ public float WaterAlphaHeightMin;
        [NMS(Index = 2)]
        /* 0x63C */ public int WaterChangeTime;
        [NMS(Index = 3)]
        /* 0x640 */ public float WaterConditionTransitionTime;
        [NMS(Index = 71)]
        /* 0x644 */ public float WaterFogHeightMax;
        [NMS(Index = 109)]
        /* 0x648 */ public bool EnableWind;
        [NMS(Index = 22)]
        /* 0x649 */ public bool ForceAddCaveProps;
        [NMS(Index = 21)]
        /* 0x64A */ public bool ForceAddUnderwaterProps;
        [NMS(Index = 47)]
        /* 0x64B */ public bool MatchPlantPalettes;
    }
}
