...
{
    [NMS(GUID = 0x28B0AC2D156AD0A8, NameHash = 0x42902548)]
    public class GcSpaceshipGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 1)]
        /* 0x17F4 */ public NMSString0x20 SpookShipDataName;
        [NMS(Index = 77)]
        /* 0x1814 */ public bool _3rdPersonShipEnabled;
        [NMS(Index = 232)]
        /* 0x1815 */ public TkCurveType _3rdPersonWarpWanderCurve;
        [NMS(Index = 10)]
        /* 0x1816 */ public bool AddShipToCollectionOnEnter;
        [NMS(Index = 78)]
        /* 0x1817 */ public bool AimZoomAuto;
        [NMS(Index = 9)]
        /* 0x1818 */ public bool AllowSideScreenPointing;
        [NMS(Index = 405)]
        /* 0x1819 */ public bool AltAtmosphere;
        [NMS(Index = 75)]
        /* 0x181A */ public bool AltControls;
        [NMS(Index = 83)]
        /* 0x181B */ public bool ApplyHeightAlign;
        [NMS(Index = 82)]
        /* 0x181C */ public bool ApplyHeightForce;
        [NMS(Index = 357)]
        /* 0x181D */ public bool AutoEjectOnLanding;
        [NMS(Index = 94)]
        /* 0x181E */ public TkCurveType CockpitExitAnimCurve;
        [NMS(Index = 80)]
        /* 0x181F */ public bool CritsFromBehind;
        [NMS(Index = 562)]
        /* 0x1820 */ public TkCurveType DeflectCurve;
        [NMS(Index = 159)]
        /* 0x1821 */ public TkCurveType DirectionDockingIndicatorCurve;
        [NMS(Index = 84)]
        /* 0x1822 */ public bool DoPreCollision;
        [NMS(Index = 81)]
        /* 0x1823 */ public bool DrawLineLockTarget;
        [NMS(Index = 79)]
        /* 0x1824 */ public bool EnableDepthTestedCrosshairSections;
        [NMS(Index = 11)]
        /* 0x1825 */ public bool EnablePulseDriveSpaceStationOrient;
        [NMS(Index = 292)]
        /* 0x1826 */ public TkCurveType GroundHeightHardCurve;
        [NMS(Index = 288)]
        /* 0x1827 */ public TkCurveType GroundHeightSoftCurve;
        [NMS(Index = 358)]
        /* 0x1828 */ public bool LandedCockpitFreeLook;
        [NMS(Index = 273)]
        /* 0x1829 */ public bool LandingCheckBuildings;
        [NMS(Index = 317)]
        /* 0x182A */ public TkCurveType LandingCurve;
        [NMS(Index = 318)]
        /* 0x182B */ public TkCurveType LandingCurveHeavy;
        [NMS(Index = 319)]
        /* 0x182C */ public TkCurveType LandingCurveWater;
        [NMS(Index = 504)]
        /* 0x182D */ public TkCurveType MiniWarpCurve;
        [NMS(Index = 316)]
        /* 0x182E */ public TkCurveType PitchCorrectHeightCurve;
        [NMS(Index = 34)]
        /* 0x182F */ public TkCurveType RudderToRollCurve;
        [NMS(Index = 197)]
        /* 0x1830 */ public TkCurveType ShieldEffectHitCurve;
        [NMS(Index = 669)]
        /* 0x1831 */ public bool SpaceCombatFollowModeUseBoost;
        [NMS(Index = 668)]
        /* 0x1832 */ public bool SpaceCombatFollowModeUseEvadeTarget;
        [NMS(Index = 76)]
        /* 0x1833 */ public bool SpaceMapInWorld;
        [NMS(Index = 85)]
        /* 0x1834 */ public bool SpeedTrackModeEnabled;
        [NMS(Index = 233)]
        /* 0x1835 */ public bool SpringSpeedSpringEnabled;
        [NMS(Index = 169)]
        /* 0x1836 */ public bool TestShipAnims;
        [NMS(Index = 135)]
        /* 0x1837 */ public TkCurveType WarpInCurve;
    }
}
