...
{
    [NMS(GUID = 0xACAE8794532FB7B4, NameHash = 0xFC6CA276)]
    public class GcPlayerGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 355)]
        /* 0x18AC */ public int StealthBaseCharge;
        [NMS(Index = 353)]
        /* 0x18B0 */ public float StealthDrainRate;
        [NMS(Index = 352)]
        /* 0x18B4 */ public float StealthMinLevel;
        [NMS(Index = 354)]
        /* 0x18B8 */ public float StealthRechargeRate;
        [NMS(Index = 703)]
        /* 0x18BC */ public float StickDeadZoneMax;
        [NMS(Index = 702)]
        /* 0x18C0 */ public float StickDeadZoneMin;
        [NMS(Index = 88)]
        /* 0x18C4 */ public float StickYDampingThreshold;
        [NMS(Index = 466)]
        /* 0x18C8 */ public int SuitInventoryStartSeed;
        [NMS(Index = 23)]
        /* 0x18CC */ public float SummonArcRange;
        [NMS(Index = 118)]
        /* 0x18D0 */ public float SummonShipDirectionChangeDeadZoneAngle;
        [NMS(Index = 777)]
        /* 0x18D4 */ public float TakeDamageImpulse;
        [NMS(Index = 788)]
        /* 0x18D8 */ public float TargetDistance;
        [NMS(Index = 789)]
        /* 0x18DC */ public float TargetRadius;
        [NMS(Index = 11)]
        /* 0x18E0 */ public float TeleportAppearEffectSpeed;
        [NMS(Index = 128)]
        /* 0x18E4 */ public float TeleportArcLengthMultiplier;
        [NMS(Index = 119)]
        /* 0x18E8 */ public float TeleportArcRadius;
        [NMS(Index = 120)]
        /* 0x18EC */ public float TeleportArcRadiusInner;
        [NMS(Index = 59)]
        /* 0x18F0 */ public float TeleportBallCompletionFactorFadeout;
        [NMS(Index = 56)]
        /* 0x18F4 */ public float TeleportBallDistanceFadeAlpha;
        [NMS(Index = 54)]
        /* 0x18F8 */ public float TeleportBallFadeMinDistance;
        [NMS(Index = 55)]
        /* 0x18FC */ public float TeleportBallFadeRange;
        [NMS(Index = 57)]
        /* 0x1900 */ public float TeleportBallRadius;
        [NMS(Index = 130)]
        /* 0x1904 */ public float TeleportBeamAnimHeight;
        [NMS(Index = 129)]
        /* 0x1908 */ public float TeleportBeamAnimSpeed;
        [NMS(Index = 126)]
        /* 0x190C */ public float TeleportBeamGravity;
        [NMS(Index = 127)]
        /* 0x1910 */ public float TeleportBeamGravityMax;
        [NMS(Index = 53)]
        /* 0x1914 */ public float TeleportChargeFadeInTime;
        [NMS(Index = 50)]
        /* 0x1918 */ public float TeleportChargeMaxDistance;
        [NMS(Index = 49)]
        /* 0x191C */ public float TeleportChargeMinDistance;
        [NMS(Index = 52)]
        /* 0x1920 */ public float TeleportChargeMinTime;
        [NMS(Index = 51)]
        /* 0x1924 */ public float TeleportChargeMoveSpeed;
        [NMS(Index = 168)]
        /* 0x1928 */ public float TeleportDirectionAltHandRange;
        [NMS(Index = 12)]
        /* 0x192C */ public float TeleportDisappearEffectSpeed;
        [NMS(Index = 124)]
        /* 0x1930 */ public float TeleportHmdMaxFade;
        [NMS(Index = 123)]
        /* 0x1934 */ public float TeleportHmdMinFade;
        [NMS(Index = 125)]
        /* 0x1938 */ public float TeleportHmdOutFactor;
        [NMS(Index = 136)]
        /* 0x193C */ public float TeleportInitiateThreshold;
        [NMS(Index = 167)]
        /* 0x1940 */ public float TeleportInstantTravelDistance;
        [NMS(Index = 131)]
        /* 0x1944 */ public float TeleportLastKnownThreshold;
        [NMS(Index = 139)]
        /* 0x1948 */ public float TeleportLineBezierDistanceFactor;
        [NMS(Index = 138)]
        /* 0x194C */ public float TeleportLineBezierOffset;
        [NMS(Index = 133)]
        /* 0x1950 */ public float TeleportLineEndFadeEnd;
        [NMS(Index = 132)]
        /* 0x1954 */ public float TeleportLineEndFadeStart;
        [NMS(Index = 135)]
        /* 0x1958 */ public float TeleportLineFadeRange;
        [NMS(Index = 134)]
        /* 0x195C */ public float TeleportLineFadeStart;
        [NMS(Index = 47)]
        /* 0x1960 */ public float TeleportMaxTravelDistance;
        [NMS(Index = 48)]
        /* 0x1964 */ public float TeleportMaxTravelDistanceVertical;
        [NMS(Index = 169)]
        /* 0x1968 */ public float TeleportMotionOffsetAmount;
        [NMS(Index = 170)]
        /* 0x196C */ public float TeleportMotionOffsetUp;
        [NMS(Index = 121)]
        /* 0x1970 */ public float TeleportStrafeDistance;
        [NMS(Index = 171)]
        /* 0x1974 */ public float TeleportTotalTime;
        [NMS(Index = 58)]
        /* 0x1978 */ public float TeleportTravelSurfaceAngle;
        [NMS(Index = 550)]
        /* 0x197C */ public float TemperatureDisplaySampleTime;
        [NMS(Index = 889)]
        /* 0x1980 */ public float TerrainLaserRange;
        [NMS(Index = 621)]
        /* 0x1984 */ public float ThirdPersonRecoilMultiplier;
        [NMS(Index = 21)]
        /* 0x1988 */ public float ThirdPersonWeaponAttachRotationCorrectionAngle;
        [NMS(Index = 22)]
        /* 0x198C */ public float ThirdPersonWeaponXOffset;
        [NMS(Index = 848)]
        /* 0x1990 */ public float TimeHoldDownAccelerateToLaunchFromOutpost;
        [NMS(Index = 238)]
        /* 0x1994 */ public float TrackArrowStaticTargetOffsetMultiplier;
        [NMS(Index = 495)]
        /* 0x1998 */ public float TraderApproachDistance;
        [NMS(Index = 493)]
        /* 0x199C */ public float TraderApproachTime;
        [NMS(Index = 509)]
        /* 0x19A0 */ public int TraderCommunicationBanMaxTime;
        [NMS(Index = 508)]
        /* 0x19A4 */ public int TraderCommunicationBanMinTime;
        [NMS(Index = 494)]
        /* 0x19A8 */ public float TraderHailDistance;
        [NMS(Index = 492)]
        /* 0x19AC */ public float TraderHailTime;
        [NMS(Index = 507)]
        /* 0x19B0 */ public float TraderHealthFightThreshold;
        [NMS(Index = 496)]
        /* 0x19B4 */ public float TraderSpamTimeWait;
        [NMS(Index = 497)]
        /* 0x19B8 */ public float TraderStayCloseLockOffset;
        [NMS(Index = 498)]
        /* 0x19BC */ public float TraderStayCloseLockSin1Coeff;
        [NMS(Index = 499)]
        /* 0x19C0 */ public float TraderStayCloseLockSin1Offset;
        [NMS(Index = 500)]
        /* 0x19C4 */ public float TraderStayCloseLockSin2Coeff;
        [NMS(Index = 501)]
        /* 0x19C8 */ public float TraderStayCloseLockSin2Offset;
        [NMS(Index = 502)]
        /* 0x19CC */ public float TraderStayCloseLockSinsAdd;
        [NMS(Index = 503)]
        /* 0x19D0 */ public float TraderStayCloseLockSpread;
        [NMS(Index = 504)]
        /* 0x19D4 */ public float TraderStayCloseLockSpreadAdd;
        [NMS(Index = 505)]
        /* 0x19D8 */ public float TraderStayCloseLockSpreadTime;
        [NMS(Index = 200)]
        /* 0x19DC */ public float UnderwaterBrake;
        [NMS(Index = 201)]
        /* 0x19E0 */ public float UnderwaterFloat;
        [NMS(Index = 202)]
        /* 0x19E4 */ public float UnderwaterFloatForce;
        [NMS(Index = 204)]
        /* 0x19E8 */ public float UnderwaterFloatFreq;
        [NMS(Index = 203)]
        /* 0x19EC */ public float UnderwaterFloatRange;
        [NMS(Index = 195)]
        /* 0x19F0 */ public float UnderwaterForce;
        [NMS(Index = 193)]
        /* 0x19F4 */ public float UnderwaterImpact;
        [NMS(Index = 199)]
        /* 0x19F8 */ public float UnderwaterJetpackEscapeForce;
        [NMS(Index = 197)]
        /* 0x19FC */ public float UnderwaterJetpackForce;
        [NMS(Index = 187)]
        /* 0x1A00 */ public float UnderwaterMargin;
        [NMS(Index = 198)]
        /* 0x1A04 */ public float UnderwaterMaxJetpackEscapeSpeed;
        [NMS(Index = 196)]
        /* 0x1A08 */ public float UnderwaterMaxJetpackSpeed;
        [NMS(Index = 194)]
        /* 0x1A0C */ public float UnderwaterMaxSpeed;
        [NMS(Index = 188)]
        /* 0x1A10 */ public float UnderwaterMinDepth;
        [NMS(Index = 191)]
        /* 0x1A14 */ public float UnderwaterSurfaceForceFlattenAngleMin;
        [NMS(Index = 192)]
        /* 0x1A18 */ public float UnderwaterSurfaceForceFlattenAngleRange;
        [NMS(Index = 189)]
        /* 0x1A1C */ public float UnderwaterSurfaceTension;
        [NMS(Index = 190)]
        /* 0x1A20 */ public float UnderwaterSurfaceTensionOffset;
        [NMS(Index = 400)]
        /* 0x1A24 */ public float VehicleHazardDampingModifier;
        [NMS(Index = 890)]
        /* 0x1A28 */ public float VehicleLaserRange;
        [NMS(Index = 245)]
        /* 0x1A2C */ public float VehicleRaceResultsHintTime;
        [NMS(Index = 386)]
        /* 0x1A30 */ public float VRModeHazardTimeMultiplier;
        [NMS(Index = 387)]
        /* 0x1A34 */ public float VRStartHazardTimeMultiplier;
        [NMS(Index = 458)]
        /* 0x1A38 */ public float WalkerAlertRange;
        [NMS(Index = 460)]
        /* 0x1A3C */ public float WalkerSightAngle;
        [NMS(Index = 459)]
        /* 0x1A40 */ public float WalkerSightRange;
        [NMS(Index = 585)]
        /* 0x1A44 */ public float WantedDroneEventRadius;
        [NMS(Index = 700)]
        /* 0x1A48 */ public float WantedEnemyAttackAmount;
        [NMS(Index = 588)]
        /* 0x1A4C */ public float WantedLevelDelay;
        [NMS(Index = 247)]
        /* 0x1A50 */ public float WantedLevelPlayerRange;
        [NMS(Index = 248)]
        /* 0x1A54 */ public float WantedLevelPlayerRangeSpace;
        [NMS(Index = 591)]
        /* 0x1A58 */ public float WantedMinorCrimeAmount;
        [NMS(Index = 587)]
        /* 0x1A5C */ public float WantedMinPlanetTime;
        [NMS(Index = 586)]
        /* 0x1A60 */ public float WantedMinSpaceTime;
        [NMS(Index = 592)]
        /* 0x1A64 */ public float WantedTimeoutAggressive;
        [NMS(Index = 590)]
        /* 0x1A68 */ public float WantedWitnessFuzzyTime;
        [NMS(Index = 589)]
        /* 0x1A6C */ public float WantedWitnessTimer;
        [NMS(Index = 749)]
        /* 0x1A70 */ public float WeaponBobBlendTime;
        [NMS(Index = 748)]
        /* 0x1A74 */ public float WeaponBobFactorRun;
        [NMS(Index = 747)]
        /* 0x1A78 */ public float WeaponBobFactorWalk;
        [NMS(Index = 746)]
        /* 0x1A7C */ public float WeaponBobFactorWalkDeadZone;
        [NMS(Index = 752)]
        /* 0x1A80 */ public float WeaponCannonMinUnchargedShotThreshold;
        [NMS(Index = 753)]
        /* 0x1A84 */ public float WeaponCannonMinUnchargedShotTime;
        [NMS(Index = 751)]
        /* 0x1A88 */ public float WeaponCannonMinWeaponTimer;
        [NMS(Index = 740)]
        /* 0x1A8C */ public float WeaponChangeModeTime;
        [NMS(Index = 415)]
        /* 0x1A90 */ public float WeaponCoolFactor;
        [NMS(Index = 754)]
        /* 0x1A94 */ public float WeaponGrenadeTime;
        [NMS(Index = 755)]
        /* 0x1A98 */ public float WeaponGunTime;
        [NMS(Index = 744)]
        /* 0x1A9C */ public float WeaponHolsterDelay;
        [NMS(Index = 745)]
        /* 0x1AA0 */ public float WeaponLag;
        [NMS(Index = 743)]
        /* 0x1AA4 */ public float WeaponLowerDelay;
        [NMS(Index = 412)]
        /* 0x1AA8 */ public float WeaponPriceExp2;
        [NMS(Index = 756)]
        /* 0x1AAC */ public float WeaponRailFireTime;
        [NMS(Index = 757)]
        /* 0x1AB0 */ public float WeaponRailRechargeTime;
        [NMS(Index = 296)]
        /* 0x1AB4 */ public float WeaponShotgunSlowdown;
        [NMS(Index = 268)]
        /* 0x1AB8 */ public float WeaponZoomFOV;
        [NMS(Index = 273)]
        /* 0x1ABC */ public float WeaponZoomHorzRotation;
        [NMS(Index = 271)]
        /* 0x1AC0 */ public float WeaponZoomRecoilMultiplier;
        [NMS(Index = 272)]
        /* 0x1AC4 */ public float WeaponZoomVertRotation;
        [NMS(Index = 527)]
        /* 0x1AC8 */ public float WitnessAIDamageAngle;
        [NMS(Index = 526)]
        /* 0x1ACC */ public float WitnessAIDamageDistance;
        [NMS(Index = 240)]
        /* 0x1AD0 */ public float WitnessSenseEnhancement;
        [NMS(Index = 239)]
        /* 0x1AD4 */ public float WitnessSenseEnhancementTime;
        [NMS(Index = 150)]
        /* 0x1AD8 */ public int WordCategoriesRequiredToConverse;
        [NMS(Index = 455)]
        /* 0x1ADC */ public float WoundDamageDecayTime;
        [NMS(Index = 453)]
        /* 0x1AE0 */ public float WoundDamageLimit;
        [NMS(Index = 454)]
        /* 0x1AE4 */ public float WoundDamageLimitShip;
        [NMS(Index = 452)]
        /* 0x1AE8 */ public float WoundTimeMinimum;
        [NMS(Index = 660)]
        /* 0x1AEC */ public TkCurveType AimDisperseCurve;
        [NMS(Index = 637)]
        /* 0x1AED */ public bool AutoAim;
        [NMS(Index = 648)]
        /* 0x1AEE */ public TkCurveType AutoAimCentreOffsetCurve;
        [NMS(Index = 647)]
        /* 0x1AEF */ public TkCurveType AutoAimDotCurve;
        [NMS(Index = 624)]
        /* 0x1AF0 */ public bool BoltcasterHasTracer;
        [NMS(Index = 382)]
        /* 0x1AF1 */ public bool ClampPitch;
        [NMS(Index = 222)]
        /* 0x1AF2 */ public bool CreatureRideFade;
        [NMS(Index = 87)]
        /* 0x1AF3 */ public bool DoPlayerAppearInVehicleEffect;
        [NMS(Index = 381)]
        /* 0x1AF4 */ public bool EnableHeadMovements;
        [NMS(Index = 98)]
        /* 0x1AF5 */ public bool EnableLeaning;
        [NMS(Index = 99)]
        /* 0x1AF6 */ public bool EnablePointDownToSmoothMove;
        [NMS(Index = 265)]
        /* 0x1AF7 */ public bool FireButtonReloadsWeapon;
        [NMS(Index = 3)]
        /* 0x1AF8 */ public bool ForceFreighterProcTechRandom;
        [NMS(Index = 274)]
        /* 0x1AF9 */ public bool FrontShieldEnabled;
        [NMS(Index = 163)]
        /* 0x1AFA */ public bool HandSwimEnabled;
        [NMS(Index = 442)]
        /* 0x1AFB */ public bool HideHazardPanel;
        [NMS(Index = 100)]
        /* 0x1AFC */ public bool HmdSmoothTurnAlways;
        [NMS(Index = 92)]
        /* 0x1AFD */ public bool InteractNearbyRadiusEnabled;
        [NMS(Index = 443)]
        /* 0x1AFE */ public bool InventoryDamage;
        [NMS(Index = 447)]
        /* 0x1AFF */ public bool LuckyWithTech;
        [NMS(Index = 417)]
        /* 0x1B00 */ public bool MouseCrosshairVisible;
        [NMS(Index = 435)]
        /* 0x1B01 */ public TkCurveType MouseFlightCurve;
        [NMS(Index = 230)]
        /* 0x1B02 */ public bool MultiplayerShareWanted;
        [NMS(Index = 444)]
        /* 0x1B03 */ public bool NeverPreyedOn;
        [NMS(Index = 94)]
        /* 0x1B04 */ public bool PassiveLook;
        [NMS(Index = 446)]
        /* 0x1B05 */ public bool PermanantAltFire;
        [NMS(Index = 445)]
        /* 0x1B06 */ public bool PermanantFire;
        [NMS(Index = 15)]
        /* 0x1B07 */ public bool RecenterViewWhenEnteringShip;
        [NMS(Index = 231)]
        /* 0x1B08 */ public bool ReportAllProjectileDamage;
        [NMS(Index = 89)]
        /* 0x1B09 */ public bool RequireHandsOnShipControls;
        [NMS(Index = 326)]
        /* 0x1B0A */ public bool RocketBootsEnabled;
        [NMS(Index = 327)]
        /* 0x1B0B */ public bool RocketBootsUseCustomCamera;
        [NMS(Index = 90)]
        /* 0x1B0C */ public bool ShowFirstPersonCharacterShadowPCVR;
        [NMS(Index = 91)]
        /* 0x1B0D */ public bool ShowFirstPersonCharacterShadowPSVR;
        [NMS(Index = 266)]
        /* 0x1B0E */ public bool ShowLowAmmoWarning;
        [NMS(Index = 704)]
        /* 0x1B0F */ public TkCurveType StickCurve;
        [NMS(Index = 137)]
        /* 0x1B10 */ public bool TeleportRecentre;
        [NMS(Index = 464)]
        /* 0x1B11 */ public bool UpgradeExosuitWithProduct;
        [NMS(Index = 440)]
        /* 0x1B12 */ public bool UseEnergy;
        [NMS(Index = 441)]
        /* 0x1B13 */ public bool UseHazardProtection;
        [NMS(Index = 236)]
        /* 0x1B14 */ public bool UseLargeHealthBar;
        [NMS(Index = 750)]
        /* 0x1B15 */ public TkCurveType WeaponBobBlendCurve;
        [NMS(Index = 267)]
        /* 0x1B16 */ public bool WeaponZoomEnabled;
    }
}
