...
namespace libMBIN.NMS.Globals
{
    ...
    public class GcPlayerGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 89)]
        /* 0x1AC8 */ public bool ShowFirstPersonCharacterShadowPCVR;
        [NMS(Index = 90)]
        /* 0x1AC9 */ public bool ShowFirstPersonCharacterShadowPSVR;
        [NMS(Index = 265)]
        /* 0x1ACA */ public bool ShowLowAmmoWarning;
        [NMS(Index = 702)]
        /* 0x1ACB */ public TkCurveType StickCurve;
        [NMS(Index = 136)]
        /* 0x1ACC */ public bool TeleportRecentre;
        [NMS(Index = 463)]
        /* 0x1ACD */ public bool UpgradeExosuitWithProduct;
        [NMS(Index = 439)]
        /* 0x1ACE */ public bool UseEnergy;
        [NMS(Index = 440)]
        /* 0x1ACF */ public bool UseHazardProtection;
        [NMS(Index = 235)]
        /* 0x1AD0 */ public bool UseLargeHealthBar;
        [NMS(Index = 748)]
        /* 0x1AD1 */ public TkCurveType WeaponBobBlendCurve;
        [NMS(Index = 266)]
        /* 0x1AD2 */ public bool WeaponZoomEnabled;
    }
}
