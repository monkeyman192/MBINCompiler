...
{
    [NMS(GUID = 0x38151AB22C14FF99, NameHash = 0xD1FA1B1C)]
    public class GcUIGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 855, Size = 0x5, EnumType = typeof(GcGalaxyStarTypes.GalaxyStarTypeEnum))]
        /* 0x25D0 */ public Colour[] SystemHooverLEDColours;
        [NMS(Index = 856, Size = 0x5, EnumType = typeof(GcGalaxyStarTypes.GalaxyStarTypeEnum))]
        ...
        [NMS(Index = 1396, Size = 0x7, EnumType = typeof(GcSettlementStatType.SettlementStatTypeEnum))]
        /* 0x4FD0 */ public NMSString0x20A[] SettlementStatFormatLoc;
        [NMS(Index = 1395, Size = 0x7, EnumType = typeof(GcSettlementStatType.SettlementStatTypeEnum))]
        /* 0x50B0 */ public NMSString0x20A[] SettlementStatLoc;
        [NMS(Index = 1397, Size = 0x7, EnumType = typeof(GcSettlementStatType.SettlementStatTypeEnum))]
        ...
        [NMS(Index = 698, Size = 0x13, EnumType = typeof(GcPlayerWeapons.WeaponModeEnum))]
        ...
        [NMS(Index = 120)]
        /* 0x646C */ public float PlacedMarkerFadeTime;
        [NMS(Index = 112)]
        /* 0x6470 */ public float PlanetDataExtraRadius;
        [NMS(Index = 954)]
        /* 0x6474 */ public float PlanetLabelAngle;
        [NMS(Index = 953)]
        /* 0x6478 */ public float PlanetLabelTime;
        [NMS(Index = 1183)]
        /* 0x647C */ public float PlanetPoleMaxDotProduct;
        [NMS(Index = 494)]
        /* 0x6480 */ public float PlanetRaidMarkerOffset;
        [NMS(Index = 662)]
        /* 0x6484 */ public float PlanetScanDelayTime;
        [NMS(Index = 1090)]
        /* 0x6488 */ public float PopupActivateTime;
        [NMS(Index = 1091)]
        /* 0x648C */ public float PopupDeactivateTime;
        [NMS(Index = 1089)]
        /* 0x6490 */ public float PopupDebounceTime;
        [NMS(Index = 1078)]
        /* 0x6494 */ public float PopupSlotWidthOffset;
        [NMS(Index = 329)]
        /* 0x6498 */ public float PopupValueSectionBaseHeight;
        [NMS(Index = 330)]
        /* 0x649C */ public float PopupValueSectionHeight;
        [NMS(Index = 1076)]
        /* 0x64A0 */ public float PopupXClampOffset;
        [NMS(Index = 1077)]
        /* 0x64A4 */ public float PopupXClampOffsetRightAligned;
        [NMS(Index = 176)]
        /* 0x64A8 */ public float ProjectorGrabBorderPercent;
        [NMS(Index = 175)]
        /* 0x64AC */ public float ProjectorGrabDistanceBias;
        [NMS(Index = 172)]
        /* 0x64B0 */ public float ProjectorGrabResetTime;
        [NMS(Index = 170)]
        /* 0x64B4 */ public float ProjectorScale;
        [NMS(Index = 216)]
        /* 0x64B8 */ public float QuickMenuAlpha;
        [NMS(Index = 125)]
        /* 0x64BC */ public float QuickMenuCentrePos;
        [NMS(Index = 127)]
        /* 0x64C0 */ public float QuickMenuCentreSideOffset;
        [NMS(Index = 563)]
        /* 0x64C4 */ public float QuickMenuCloseTime;
        [NMS(Index = 215)]
        /* 0x64C8 */ public float QuickMenuCursorScale;
        [NMS(Index = 564)]
        /* 0x64CC */ public float QuickMenuErrorTime;
        [NMS(Index = 255)]
        /* 0x64D0 */ public float QuickMenuHighlightRate;
        [NMS(Index = 256)]
        /* 0x64D4 */ public float QuickMenuHoldNavTime;
        [NMS(Index = 251)]
        /* 0x64D8 */ public float QuickMenuInteractAdjustX;
        [NMS(Index = 252)]
        /* 0x64DC */ public float QuickMenuInteractAdjustY;
        [NMS(Index = 254)]
        /* 0x64E0 */ public int QuickMenuScreenHeight;
        [NMS(Index = 253)]
        /* 0x64E4 */ public int QuickMenuScreenWidth;
        [NMS(Index = 126)]
        /* 0x64E8 */ public float QuickMenuSideOffset;
        [NMS(Index = 247)]
        /* 0x64EC */ public float QuickMenuSwipeHeightMax;
        [NMS(Index = 246)]
        /* 0x64F0 */ public float QuickMenuSwipeHeightMin;
        [NMS(Index = 1145)]
        /* 0x64F4 */ public float RadialMenuInnerRadius;
        [NMS(Index = 1146)]
        /* 0x64F8 */ public float RadialMenuInnerRadiusCursor;
        [NMS(Index = 1147)]
        /* 0x64FC */ public float RadialMenuWedgeOffset;
        [NMS(Index = 483)]
        /* 0x6500 */ public float RefinerAutoCloseTime;
        [NMS(Index = 471)]
        /* 0x6504 */ public float RefinerBeginDialInnerRadius;
        [NMS(Index = 470)]
        /* 0x6508 */ public float RefinerPadStartDecayTime;
        [NMS(Index = 469)]
        /* 0x650C */ public float RefinerPadStartTime;
        [NMS(Index = 472)]
        /* 0x6510 */ public float RefinerProgressDialInnerRadius;
        [NMS(Index = 452)]
        /* 0x6514 */ public float RepairTechLabelOffset;
        [NMS(Index = 442)]
        /* 0x6518 */ public float RepairTechRepairedMessageTime;
        [NMS(Index = 440)]
        /* 0x651C */ public float RepairTechRepairedWaitTime1;
        [NMS(Index = 441)]
        /* 0x6520 */ public float RepairTechRepairedWaitTime2;
        [NMS(Index = 1376)]
        /* 0x6524 */ public float ReportBaseFlashDelay;
        [NMS(Index = 1375)]
        /* 0x6528 */ public float ReportBaseFlashIntensity;
        [NMS(Index = 1374)]
        /* 0x652C */ public float ReportBaseFlashTime;
        [NMS(Index = 1377)]
        /* 0x6530 */ public float ReportCameraSpeed;
        [NMS(Index = 785)]
        /* 0x6534 */ public float ScanEventArrowOffsetMultiplier;
        [NMS(Index = 787)]
        /* 0x6538 */ public float ScanEventArrowOffsetMultiplierFresh;
        [NMS(Index = 788)]
        /* 0x653C */ public float ScanEventArrowOffsetMultiplierLerpTime;
        [NMS(Index = 786)]
        /* 0x6540 */ public float ScanEventArrowOffsetMultiplierOneEvent;
        [NMS(Index = 784)]
        /* 0x6544 */ public float ScanEventArrowPlayerFadeDistance;
        [NMS(Index = 783)]
        /* 0x6548 */ public float ScanEventArrowPlayerFadeRange;
        [NMS(Index = 789)]
        /* 0x654C */ public float ScanEventArrowSecondaryAlpha;
        [NMS(Index = 782)]
        /* 0x6550 */ public float ScanEventArrowShipFadeDistance;
        [NMS(Index = 781)]
        /* 0x6554 */ public float ScanEventArrowShipFadeRange;
        [NMS(Index = 790)]
        /* 0x6558 */ public GcAudioWwiseEvents ScanEventIconAudio;
        [NMS(Index = 359)]
        /* 0x655C */ public float ScannableIconMergeAngle;
        [NMS(Index = 1057)]
        /* 0x6560 */ public float ScanTime;
        [NMS(Index = 101)]
        /* 0x6564 */ public float SeasonalRingChangeTime;
        [NMS(Index = 99)]
        /* 0x6568 */ public float SeasonalRingMultiplier;
        [NMS(Index = 100)]
        /* 0x656C */ public float SeasonalRingPulseTime;
        [NMS(Index = 34)]
        /* 0x6570 */ public float SeasonEndAutoHighlightDuration;
        [NMS(Index = 35)]
        /* 0x6574 */ public float SeasonEndAutoHighlightDurationMilestone;
        [NMS(Index = 33)]
        /* 0x6578 */ public GcAudioWwiseEvents SeasonEndAutoHighlightSFX;
        [NMS(Index = 32)]
        /* 0x657C */ public float SeasonEndRewardsMaxScrollRate;
        [NMS(Index = 31)]
        /* 0x6580 */ public float SeasonEndRewardsPageOpenDelayTime;
        [NMS(Index = 97)]
        /* 0x6584 */ public int SeasonFinalStageIndex;
        [NMS(Index = 869)]
        /* 0x6588 */ public float SeasonMessageDelayTime;
        [NMS(Index = 90)]
        /* 0x658C */ public float SentinelsDisabledHUDMessageTime;
        [NMS(Index = 1391)]
        /* 0x6590 */ public float SettlementStatInnerRadius;
        [NMS(Index = 1392)]
        /* 0x6594 */ public float SettlementStatOuterRadius;
        [NMS(Index = 1012)]
        /* 0x6598 */ public float ShieldHazardPulseRate;
        [NMS(Index = 1014)]
        /* 0x659C */ public float ShieldHazardPulseThreshold;
        [NMS(Index = 1011)]
        /* 0x65A0 */ public float ShieldPulseTime;
        [NMS(Index = 1010)]
        /* 0x65A4 */ public float ShieldSpringTime;
        [NMS(Index = 0)]
        /* 0x65A8 */ public float ShipBuilderBarTime;
        [NMS(Index = 7)]
        /* 0x65AC */ public float ShipBuilderEndCircleRadius;
        [NMS(Index = 11)]
        /* 0x65B0 */ public float ShipBuilderLineLengthFadeMax;
        [NMS(Index = 10)]
        /* 0x65B4 */ public float ShipBuilderLineLengthFadeMin;
        [NMS(Index = 9)]
        /* 0x65B8 */ public float ShipBuilderLineMinFade;
        [NMS(Index = 8)]
        /* 0x65BC */ public float ShipBuilderLineWidth;
        [NMS(Index = 5)]
        /* 0x65C0 */ public float ShipBuilderSlotDropLength;
        [NMS(Index = 1)]
        /* 0x65C4 */ public float ShipBuilderSlotLineDefaultWidthFactor;
        [NMS(Index = 3)]
        /* 0x65C8 */ public float ShipBuilderSlotLineMaxFactor;
        [NMS(Index = 2)]
        /* 0x65CC */ public float ShipBuilderSlotLineMinFactor;
        [NMS(Index = 4)]
        /* 0x65D0 */ public float ShipBuilderSlotStartOffset;
        [NMS(Index = 6)]
        /* 0x65D4 */ public float ShipBuilderStartCircleRadius;
        [NMS(Index = 520)]
        /* 0x65D8 */ public float ShipDamageDirectionIndicatorFadeRange;
        [NMS(Index = 519)]
        /* 0x65DC */ public float ShipDamageDirectionIndicatorRadius;
        [NMS(Index = 779)]
        /* 0x65E0 */ public float ShipDesatDamper;
        [NMS(Index = 778)]
        /* 0x65E4 */ public float ShipFullscreenDamper;
        [NMS(Index = 777)]
        /* 0x65E8 */ public float ShipFullscreenDamperMin;
        [NMS(Index = 669)]
        /* 0x65EC */ public float ShipHeadsUpDisplayDistance;
        [NMS(Index = 670)]
        /* 0x65F0 */ public float ShipHeadsUpLineFadeTime;
        [NMS(Index = 304)]
        /* 0x65F4 */ public float ShipHologramInWorldUIHeightAdjust;
        [NMS(Index = 305)]
        /* 0x65F8 */ public float ShipHologramInWorldUIHeightAdjustV2;
        [NMS(Index = 992)]
        /* 0x65FC */ public float ShipHUDHitPointSize;
        [NMS(Index = 991)]
        /* 0x6600 */ public float ShipHUDHitPointTime;
        [NMS(Index = 141)]
        /* 0x6604 */ public float ShipHUDMarkerHideDistance;
        [NMS(Index = 142)]
        /* 0x6608 */ public float ShipHUDMarkerOffset;
        [NMS(Index = 976)]
        /* 0x660C */ public float ShipHUDMaxOffscreenTargetDist;
        [NMS(Index = 973)]
        /* 0x6610 */ public float ShipHUDMissileLockSizeMax;
        [NMS(Index = 972)]
        /* 0x6614 */ public float ShipHUDMissileLockSizeMin;
        [NMS(Index = 975)]
        /* 0x6618 */ public float ShipHUDMissileLockSpringFast;
        [NMS(Index = 974)]
        /* 0x661C */ public float ShipHUDMissileLockSpringSlow;
        [NMS(Index = 979)]
        /* 0x6620 */ public float ShipHUDTargetAlpha;
        [NMS(Index = 980)]
        /* 0x6624 */ public float ShipHUDTargetArrowLength;
        [NMS(Index = 984)]
        /* 0x6628 */ public float ShipHUDTargetArrowsRotationRate;
        [NMS(Index = 981)]
        /* 0x662C */ public float ShipHUDTargetMinDist;
        [NMS(Index = 977)]
        /* 0x6630 */ public float ShipHUDTargetRadius;
        [NMS(Index = 982)]
        /* 0x6634 */ public float ShipHUDTargetRange;
        [NMS(Index = 983)]
        /* 0x6638 */ public float ShipHUDTargetScale;
        [NMS(Index = 978)]
        /* 0x663C */ public float ShipHUDTargetTriangleRadius;
        [NMS(Index = 506)]
        /* 0x6640 */ public float ShipOverheatSwitchMessageTime;
        [NMS(Index = 505)]
        /* 0x6644 */ public float ShipOverheatSwitchMessageWait;
        [NMS(Index = 1384)]
        /* 0x6648 */ public float ShipScreenTexScale;
        [NMS(Index = 238)]
        /* 0x664C */ public float ShipSideScreenHeight;
        [NMS(Index = 306)]
        /* 0x6650 */ public float ShopInteractionInWorldForcedOffset;
        [NMS(Index = 307)]
        /* 0x6654 */ public float ShopInteractionInWorldForcedOffsetV2;
        [NMS(Index = 108)]
        /* 0x6658 */ public int ShowDaysIfLessThan;
        [NMS(Index = 107)]
        /* 0x665C */ public int ShowHoursIfLessThan;
        [NMS(Index = 109)]
        /* 0x6660 */ public int ShowWeeksIfLessThan;
        [NMS(Index = 715)]
        /* 0x6664 */ public float SmallSpaceIconSize;
        [NMS(Index = 240)]
        /* 0x6668 */ public float SolidPointerLengthScale;
        [NMS(Index = 241)]
        /* 0x666C */ public float SolidPointerMaxLength;
        [NMS(Index = 239)]
        /* 0x6670 */ public float SolidPointerScale;
        [NMS(Index = 1217)]
        /* 0x6674 */ public float SpaceMapActionScale;
        [NMS(Index = 1213)]
        /* 0x6678 */ public float SpaceMapAnomalyScale;
        [NMS(Index = 1203)]
        /* 0x667C */ public float SpaceMapAspectRatio;
        [NMS(Index = 1229)]
        /* 0x6680 */ public float SpaceMapCamAngle;
        [NMS(Index = 1230)]
        /* 0x6684 */ public float SpaceMapCamDistance;
        [NMS(Index = 1228)]
        /* 0x6688 */ public float SpaceMapCamHeight;
        [NMS(Index = 541)]
        /* 0x668C */ public float SpaceMapCockpitAngle;
        [NMS(Index = 532)]
        /* 0x6690 */ public float SpaceMapCockpitScale;
        [NMS(Index = 539)]
        /* 0x6694 */ public float SpaceMapCockpitScaleAdjustAlien;
        [NMS(Index = 533)]
        /* 0x6698 */ public float SpaceMapCockpitScaleAdjustDropShip;
        [NMS(Index = 534)]
        /* 0x669C */ public float SpaceMapCockpitScaleAdjustFighter;
        [NMS(Index = 540)]
        /* 0x66A0 */ public float SpaceMapCockpitScaleAdjustRobot;
        [NMS(Index = 537)]
        /* 0x66A4 */ public float SpaceMapCockpitScaleAdjustRoyal;
        [NMS(Index = 538)]
        /* 0x66A8 */ public float SpaceMapCockpitScaleAdjustSail;
        [NMS(Index = 535)]
        /* 0x66AC */ public float SpaceMapCockpitScaleAdjustScientific;
        [NMS(Index = 536)]
        /* 0x66B0 */ public float SpaceMapCockpitScaleAdjustShuttle;
        [NMS(Index = 1222)]
        /* 0x66B4 */ public float SpaceMapDistance;
        [NMS(Index = 1205)]
        /* 0x66B8 */ public float SpaceMapDistanceLogScaler;
        [NMS(Index = 1224)]
        /* 0x66BC */ public float SpaceMapDistanceMultiplier;
        [NMS(Index = 1204)]
        /* 0x66C0 */ public float SpaceMapDistanceScale;
        [NMS(Index = 1227)]
        /* 0x66C4 */ public float SpaceMapFadeAngleMax;
        [NMS(Index = 1226)]
        /* 0x66C8 */ public float SpaceMapFadeAngleMin;
        [NMS(Index = 1202)]
        /* 0x66CC */ public float SpaceMapFoV;
        [NMS(Index = 1211)]
        /* 0x66D0 */ public float SpaceMapFreighterScale;
        [NMS(Index = 1225)]
        /* 0x66D4 */ public float SpaceMapHorizonThickness;
        [NMS(Index = 1232)]
        /* 0x66D8 */ public float SpaceMapLightPitch;
        [NMS(Index = 1233)]
        /* 0x66DC */ public float SpaceMapLightYaw;
        [NMS(Index = 1186)]
        /* 0x66E0 */ public float SpaceMapLineBaseFade;
        [NMS(Index = 1185)]
        /* 0x66E4 */ public float SpaceMapLineBaseScale;
        [NMS(Index = 1184)]
        /* 0x66E8 */ public float SpaceMapLineWidth;
        [NMS(Index = 1221)]
        /* 0x66EC */ public float SpaceMapMarkerScale;
        [NMS(Index = 1223)]
        /* 0x66F0 */ public float SpaceMapMaxTraderDistance;
        [NMS(Index = 1216)]
        /* 0x66F4 */ public float SpaceMapMoonScale;
        [NMS(Index = 1210)]
        /* 0x66F8 */ public float SpaceMapObjectScale;
        [NMS(Index = 1220)]
        /* 0x66FC */ public float SpaceMapPirateFreighterScale;
        [NMS(Index = 1219)]
        /* 0x6700 */ public float SpaceMapPirateFrigateScale;
        [NMS(Index = 1215)]
        /* 0x6704 */ public float SpaceMapPlanetLineOffset;
        [NMS(Index = 1214)]
        /* 0x6708 */ public float SpaceMapPlanetScale;
        [NMS(Index = 1207)]
        /* 0x670C */ public float SpaceMapScaleMin;
        [NMS(Index = 1209)]
        /* 0x6710 */ public float SpaceMapScaleRangeMax;
        [NMS(Index = 1208)]
        /* 0x6714 */ public float SpaceMapScaleRangeMin;
        [NMS(Index = 1187)]
        /* 0x6718 */ public float SpaceMapShipCombineDistance;
        [NMS(Index = 1218)]
        /* 0x671C */ public float SpaceMapShipScale;
        [NMS(Index = 1231)]
        /* 0x6720 */ public float SpaceMapShipScaleMin;
        [NMS(Index = 1212)]
        /* 0x6724 */ public float SpaceMapStationScale;
        [NMS(Index = 713)]
        /* 0x6728 */ public float SpaceMarkersBattleOffset;
        [NMS(Index = 712)]
        /* 0x672C */ public float SpaceMarkersOffset;
        [NMS(Index = 115)]
        /* 0x6730 */ public float StackSizeChangeMaxRate;
        [NMS(Index = 114)]
        /* 0x6734 */ public float StackSizeChangeMinRate;
        [NMS(Index = 113)]
        /* 0x6738 */ public float StackSizeRateChangeRate;
        [NMS(Index = 105)]
        /* 0x673C */ public float StageStingDisplayTime;
        [NMS(Index = 513)]
        /* 0x6740 */ public float StandingRewardOSDTime;
        [NMS(Index = 868)]
        /* 0x6744 */ public float StatsMessageDelayTime;
        [NMS(Index = 21)]
        /* 0x6748 */ public float StoreDialDecayTime;
        [NMS(Index = 20)]
        /* 0x674C */ public float StoreDialHoldTime;
        [NMS(Index = 22)]
        /* 0x6750 */ public float StoreDialInnerRadius;
        [NMS(Index = 23)]
        /* 0x6754 */ public float StoreDialOuterRadius;
        [NMS(Index = 75)]
        /* 0x6758 */ public float SuperchargeGradientFactor;
        [NMS(Index = 74)]
        /* 0x675C */ public float SuperchargeGradientFactorMin;
        [NMS(Index = 76)]
        /* 0x6760 */ public float SuperchargeGradientTime;
        [NMS(Index = 780)]
        /* 0x6764 */ public float SurveyObjectArrowOffsetMultiplier;
        [NMS(Index = 347)]
        /* 0x6768 */ public float TakeoffFuelMessageTime;
        [NMS(Index = 572)]
        /* 0x676C */ public float TalkBoxAlienTextSpeed;
        [NMS(Index = 574)]
        /* 0x6770 */ public float TalkBoxAlienTextTimeMax;
        [NMS(Index = 573)]
        /* 0x6774 */ public float TalkBoxAlienTextTimeMin;
        [NMS(Index = 547)]
        /* 0x6778 */ public float TargetDisplayDamageFlashTime;
        [NMS(Index = 542)]
        /* 0x677C */ public float TargetDisplayScale;
        [NMS(Index = 544)]
        /* 0x6780 */ public float TargetDisplayShipScale;
        [NMS(Index = 543)]
        /* 0x6784 */ public float TargetDisplayTorpedoScale;
        [NMS(Index = 1176)]
        /* 0x6788 */ public float TargetMarkerFadeAngleMin;
        [NMS(Index = 1177)]
        /* 0x678C */ public float TargetMarkerFadeAngleRange;
        [NMS(Index = 1175)]
        /* 0x6790 */ public float TargetMarkerScaleEnd;
        [NMS(Index = 1174)]
        /* 0x6794 */ public float TargetMarkerScaleStart;
        [NMS(Index = 1358)]
        /* 0x6798 */ public float TargetParallaxMaintenancePageMultiplier;
        [NMS(Index = 1357)]
        /* 0x679C */ public float TargetParallaxMouseMultiplier;
        [NMS(Index = 994)]
        /* 0x67A0 */ public float TargetScreenDistance;
        [NMS(Index = 993)]
        /* 0x67A4 */ public float TargetScreenFoV;
        [NMS(Index = 795)]
        /* 0x67A8 */ public float TechDisplayDelayTime;
        [NMS(Index = 444)]
        /* 0x67AC */ public float TechPopupBuildLayerHeight;
        [NMS(Index = 443)]
        /* 0x67B0 */ public float TechPopupRepairLayerHeight;
        [NMS(Index = 445)]
        /* 0x67B4 */ public float TechPopupRequirementHeight;
        [NMS(Index = 1381)]
        /* 0x67B8 */ public float TextChatMaxDisplayTime;
        [NMS(Index = 1382)]
        /* 0x67BC */ public float TextChatStayBigAfterTextInput;
        [NMS(Index = 179)]
        /* 0x67C0 */ public float TextPrintoutMultiplier;
        [NMS(Index = 180)]
        /* 0x67C4 */ public float TextPrintoutMultiplierAlien;
        [NMS(Index = 16)]
        /* 0x67C8 */ public float TextTouchScrollCap;
        [NMS(Index = 758)]
        /* 0x67CC */ public float ThirdPersonCrosshairCircle1Distance;
        [NMS(Index = 759)]
        /* 0x67D0 */ public float ThirdPersonCrosshairCircle2Distance;
        [NMS(Index = 757)]
        /* 0x67D4 */ public float ThirdPersonCrosshairDistance;
        [NMS(Index = 587)]
        /* 0x67D8 */ public float TimedEventLookTime;
        [NMS(Index = 918)]
        /* 0x67DC */ public float TooltipTime;
        [NMS(Index = 17)]
        /* 0x67E0 */ public float TouchScrollChangePageThreshold;
        [NMS(Index = 14)]
        /* 0x67E4 */ public float TouchScrollMaxDelta;
        [NMS(Index = 15)]
        /* 0x67E8 */ public float TouchScrollSpeedMul;
        [NMS(Index = 755)]
        /* 0x67EC */ public float TrackCriticalHitSize;
        [NMS(Index = 756)]
        /* 0x67F0 */ public float TrackCriticalPulseTime;
        [NMS(Index = 731)]
        /* 0x67F4 */ public float TrackLeadTargetInScale;
        [NMS(Index = 728)]
        /* 0x67F8 */ public float TrackMissileTargetPulseRate;
        [NMS(Index = 721)]
        /* 0x67FC */ public float TrackPoliceFreighterCentreOffset;
        [NMS(Index = 720)]
        /* 0x6800 */ public float TrackPrimaryCentreOffset;
        [NMS(Index = 733)]
        /* 0x6804 */ public float TrackReticuleAngle;
        [NMS(Index = 735)]
        /* 0x6808 */ public float TrackReticuleInactiveTime;
        [NMS(Index = 734)]
        /* 0x680C */ public float TrackReticuleInTime;
        [NMS(Index = 737)]
        /* 0x6810 */ public float TrackReticuleRandomDelay;
        [NMS(Index = 736)]
        /* 0x6814 */ public float TrackReticuleRandomTime;
        [NMS(Index = 732)]
        /* 0x6818 */ public float TrackReticuleScale;
        [NMS(Index = 729)]
        /* 0x681C */ public float TrackScaleCritical;
        [NMS(Index = 730)]
        /* 0x6820 */ public float TrackScaleHit;
        [NMS(Index = 722)]
        /* 0x6824 */ public float TrackTimerAlpha;
        [NMS(Index = 726)]
        /* 0x6828 */ public float TrackTimerIconExclaimRadius;
        [NMS(Index = 725)]
        /* 0x682C */ public float TrackTimerIconInnerRadius;
        [NMS(Index = 724)]
        /* 0x6830 */ public float TrackTimerIconOuterRadius;
        [NMS(Index = 723)]
        /* 0x6834 */ public float TrackTimerRadarPulseSize;
        [NMS(Index = 719)]
        /* 0x6838 */ public float TrackTypeIconSize;
        [NMS(Index = 19)]
        /* 0x683C */ public float TradePageNotifyOffset;
        [NMS(Index = 358)]
        /* 0x6840 */ public float TransferPopupCursorOffsetFactor;
        [NMS(Index = 586)]
        /* 0x6844 */ public float TransferSendOffscreenBorder;
        [NMS(Index = 495)]
        /* 0x6848 */ public float TransitionOffset;
        [NMS(Index = 309)]
        /* 0x684C */ public float TravelLineThickness;
        [NMS(Index = 308)]
        /* 0x6850 */ public float TravelTargetRadius;
        [NMS(Index = 26)]
        /* 0x6854 */ public float TrialUpsellDeclineDecayTimeQuick;
        [NMS(Index = 28)]
        /* 0x6858 */ public float TrialUpsellDeclineDecayTimeSlow;
        [NMS(Index = 29)]
        /* 0x685C */ public float TrialUpsellDeclineDialInnerRadius;
        [NMS(Index = 30)]
        /* 0x6860 */ public float TrialUpsellDeclineDialOuterRadius;
        [NMS(Index = 25)]
        /* 0x6864 */ public float TrialUpsellDeclineHoldTimeQuick;
        [NMS(Index = 27)]
        /* 0x6868 */ public float TrialUpsellDeclineHoldTimeSlow;
        [NMS(Index = 88)]
        /* 0x686C */ public int UnknownWordsToShowInCatalogue;
        [NMS(Index = 91)]
        /* 0x6870 */ public float UseZoomedOutBuildCamRadius;
        [NMS(Index = 200)]
        /* 0x6874 */ public int VRFaceLockedScreenHeight;
        [NMS(Index = 199)]
        /* 0x6878 */ public int VRFaceLockedScreenWidth;
        [NMS(Index = 345)]
        /* 0x687C */ public float WantedDetectMessageTime;
        [NMS(Index = 346)]
        /* 0x6880 */ public float WantedDetectMinTimeout;
        [NMS(Index = 864)]
        /* 0x6884 */ public float WantedLevelScanAlpha;
        [NMS(Index = 865)]
        /* 0x6888 */ public float WantedLevelScannedRate;
        [NMS(Index = 862)]
        /* 0x688C */ public float WantedLevelTimeoutPulseRate;
        [NMS(Index = 863)]
        /* 0x6890 */ public float WantedLevelWitnessAlpha;
        [NMS(Index = 861)]
        /* 0x6894 */ public float WantedLevelWitnessOffset;
        [NMS(Index = 860)]
        /* 0x6898 */ public float WantedLevelWitnessPulseRate;
        [NMS(Index = 118)]
        /* 0x689C */ public float ZoomFactorOverride;
        [NMS(Index = 930)]
        /* 0x68A0 */ public float ZoomHUDElementsOffsetX;
        [NMS(Index = 931)]
        /* 0x68A4 */ public float ZoomHUDElementsOffsetY;
        [NMS(Index = 932)]
        /* 0x68A8 */ public float ZoomHUDElementTime;
        [NMS(Index = 1277)]
        /* 0x68AC */ public NMSString0x100 HUDCircleAnimIcon;
        [NMS(Index = 1275)]
        /* 0x69AC */ public NMSString0x100 HUDDeathPointIcon;
        [NMS(Index = 1276)]
        /* 0x6AAC */ public NMSString0x100 HUDHexAnimIcon;
        [NMS(Index = 1271)]
        /* 0x6BAC */ public NMSString0x100 HUDMarkerColourIcon;
        [NMS(Index = 1269)]
        /* 0x6CAC */ public NMSString0x100 HUDMarkerIcon;
        [NMS(Index = 1270)]
        /* 0x6DAC */ public NMSString0x100 HUDMarkerPrimaryIndicatorIcon;
        [NMS(Index = 1272)]
        /* 0x6EAC */ public NMSString0x100 HUDPointIcon;
        [NMS(Index = 1274)]
        /* 0x6FAC */ public NMSString0x100 HUDSaveIcon;
        [NMS(Index = 1273)]
        /* 0x70AC */ public NMSString0x100 HUDSpaceshipIcon;
        [NMS(Index = 928)]
        /* 0x71AC */ public NMSString0x20 DistanceUnitKM;
        [NMS(Index = 927)]
        /* 0x71CC */ public NMSString0x20 DistanceUnitM;
        [NMS(Index = 929)]
        /* 0x71EC */ public NMSString0x20 DistanceUnitMpS;
        [NMS(Index = 504)]
        /* 0x720C */ public NMSString0x20 MaxDialogCharSizeIdeographicString;
        [NMS(Index = 502)]
        /* 0x722C */ public NMSString0x20 MaxDialogCharSizeRomanString;
        [NMS(Index = 196)]
        /* 0x724C */ public NMSString0x20 VRDistanceWarningUIFile;
        [NMS(Index = 392, Size = 0x10, EnumType = typeof(GcBuildMenuOption.BuildMenuOptionEnum))]
        /* 0x726C */ public bool[] BuildMenuUseSmallIconOnPad;
        [NMS(Index = 182)]
        /* 0x727C */ public bool AllowInWorldDebugBorders;
        [NMS(Index = 173)]
        /* 0x727D */ public bool AllowProjectorRepositioning;
        [NMS(Index = 316)]
        /* 0x727E */ public bool AlwaysCloseQuickMenu;
        [NMS(Index = 661)]
        /* 0x727F */ public TkCurveType ArrowBounceLeftCurve;
        [NMS(Index = 657)]
        /* 0x7280 */ public TkCurveType ArrowBounceRightCurve;
        [NMS(Index = 93)]
        /* 0x7281 */ public bool AutoScrollParagraphs;
        [NMS(Index = 420)]
        /* 0x7282 */ public bool BaseBuildingSmoothMenuWhileSnapped;
        [NMS(Index = 83)]
        /* 0x7283 */ public bool BigPicking;
        [NMS(Index = 84)]
        /* 0x7284 */ public bool BigPickingUsesNumbers;
        [NMS(Index = 157)]
        /* 0x7285 */ public bool BinocularScanScreen;
        [NMS(Index = 381)]
        /* 0x7286 */ public TkCurveType CompassCurve;
        [NMS(Index = 743)]
        /* 0x7287 */ public bool CreatureInteractLabelUseBB;
        [NMS(Index = 742)]
        /* 0x7288 */ public TkCurveType CreatureReticuleAlphaCurve;
        [NMS(Index = 741)]
        /* 0x7289 */ public TkCurveType CreatureReticuleScaleCurve;
        [NMS(Index = 682)]
        /* 0x728A */ public TkCurveType CrosshairLeadScaleCurve;
        [NMS(Index = 700)]
        /* 0x728B */ public TkCurveType CrosshairTargetLockAlphaCurve;
        [NMS(Index = 699)]
        /* 0x728C */ public TkCurveType CrosshairTargetLockCurve;
        [NMS(Index = 615)]
        /* 0x728D */ public TkCurveType DamageNumberUpCurve;
        [NMS(Index = 322)]
        /* 0x728E */ public bool DebugInventoryIndices;
        [NMS(Index = 560)]
        /* 0x728F */ public bool DebugMarkerLabels;
        [NMS(Index = 319)]
        /* 0x7290 */ public bool DebugMissionLogText;
        [NMS(Index = 321)]
        /* 0x7291 */ public bool DebugPopupSizes;
        [NMS(Index = 320)]
        /* 0x7292 */ public bool DebugShowMaintenanceScreenCentre;
        [NMS(Index = 1401)]
        /* 0x7293 */ public bool EnableAccessibleUIOnSwitch;
        [NMS(Index = 448)]
        /* 0x7294 */ public bool EnableBlackouts;
        [NMS(Index = 799)]
        /* 0x7295 */ public bool EnableBuilderRobotGreekConversion;
        [NMS(Index = 244)]
        /* 0x7296 */ public bool EnableCraftingTree;
        [NMS(Index = 181)]
        /* 0x7297 */ public bool EnableHandMenuButtons;
        [NMS(Index = 213)]
        /* 0x7298 */ public bool EnableHandMenuDebug;
        [NMS(Index = 800)]
        /* 0x7299 */ public bool EnableKanaConversion;
        [NMS(Index = 86)]
        /* 0x729A */ public bool EnablePopupUses;
        [NMS(Index = 323)]
        /* 0x729B */ public bool FixedInventoryIconPositions;
        [NMS(Index = 1088)]
        /* 0x729C */ public TkCurveType FrontendBootBarCurve;
        [NMS(Index = 1073)]
        /* 0x729D */ public TkCurveType FrontendConfirmCurve;
        [NMS(Index = 1164)]
        /* 0x729E */ public TkCurveType FrontendDoFCurve;
        [NMS(Index = 1163)]
        /* 0x729F */ public bool FrontendDoFEnableBokeh;
        [NMS(Index = 870)]
        /* 0x72A0 */ public bool HideExtremePlanetNotifications;
        [NMS(Index = 1379)]
        /* 0x72A1 */ public bool HideQuickMenuControls;
        [NMS(Index = 1312)]
        /* 0x72A2 */ public TkCurveType HUDMarkerActiveCurve;
        [NMS(Index = 1282)]
        /* 0x72A3 */ public TkCurveType HUDMarkerAnimAlphaCurve;
        [NMS(Index = 1283)]
        /* 0x72A4 */ public TkCurveType HUDMarkerAnimCurve;
        [NMS(Index = 828)]
        /* 0x72A5 */ public TkCurveType HUDPlayerTrackArrowEnergyShieldDepletedCurve;
        [NMS(Index = 833)]
        /* 0x72A6 */ public TkCurveType HUDPlayerTrackArrowEnergyShieldStartChargeCurve;
        [NMS(Index = 298)]
        /* 0x72A7 */ public bool InteractionInWorldPlayerCamAlways;
        [NMS(Index = 971)]
        /* 0x72A8 */ public TkCurveType InteractionScanSlapCurve;
        [NMS(Index = 507)]
        /* 0x72A9 */ public bool LeadTargetEnabled;
        [NMS(Index = 998)]
        /* 0x72AA */ public bool ModelRendererBGPass;
        [NMS(Index = 999)]
        /* 0x72AB */ public bool ModelRendererPass1;
        [NMS(Index = 1000)]
        /* 0x72AC */ public bool ModelRendererPass2;
        [NMS(Index = 1360)]
        /* 0x72AD */ public TkCurveType NGuiModelViewFadeInAfterRenderCurve;
        [NMS(Index = 1361)]
        /* 0x72AE */ public bool NGuiUseSeparateLayersForModelAndReflection;
        [NMS(Index = 201)]
        /* 0x72AF */ public bool OnlyShowEjectHandlesInVR;
        [NMS(Index = 64)]
        /* 0x72B0 */ public TkCurveType PadCursorUICurve;
        [NMS(Index = 497)]
        /* 0x72B1 */ public TkCurveType PageTurnCurve;
        [NMS(Index = 498)]
        /* 0x72B2 */ public TkCurveType PageTurnFadeCurve;
        [NMS(Index = 1092)]
        /* 0x72B3 */ public TkCurveType PopupActivateCurve1;
        [NMS(Index = 1093)]
        /* 0x72B4 */ public TkCurveType PopupActivateCurve2;
        [NMS(Index = 549)]
        /* 0x72B5 */ public bool ProgressiveDialogStyle;
        [NMS(Index = 1380)]
        /* 0x72B6 */ public bool QuickMenuAllowCycle;
        [NMS(Index = 245)]
        /* 0x72B7 */ public bool QuickMenuEnableSwipe;
        [NMS(Index = 318)]
        /* 0x72B8 */ public bool RepairTechUseTechIcon;
        [NMS(Index = 79)]
        /* 0x72B9 */ public bool ReplaceItemBarWithNumbers;
        [NMS(Index = 1013)]
        /* 0x72BA */ public bool ShieldHUDAlwaysOn;
        [NMS(Index = 562)]
        /* 0x72BB */ public bool ShowDamageNumbers;
        [NMS(Index = 49)]
        /* 0x72BC */ public bool ShowDifficultyForBases;
        [NMS(Index = 867)]
        /* 0x72BD */ public bool ShowJetpackNotificationForNonTerrain;
        [NMS(Index = 594)]
        /* 0x72BE */ public bool ShowOnscreenPredatorMarkers;
        [NMS(Index = 50)]
        /* 0x72BF */ public bool ShowPadlockForLockedSettings;
        [NMS(Index = 197)]
        /* 0x72C0 */ public bool ShowVRDistanceWarning;
        [NMS(Index = 117)]
        /* 0x72C1 */ public bool SkipShopIntro;
        [NMS(Index = 1206)]
        /* 0x72C2 */ public TkCurveType SpaceMapDistanceCurve;
        [NMS(Index = 1192)]
        /* 0x72C3 */ public bool SpaceMapShowAnomaly;
        [NMS(Index = 1193)]
        /* 0x72C4 */ public bool SpaceMapShowAnomalyLines;
        [NMS(Index = 1199)]
        /* 0x72C5 */ public bool SpaceMapShowFrieghterLines;
        [NMS(Index = 1198)]
        /* 0x72C6 */ public bool SpaceMapShowFrieghters;
        [NMS(Index = 1194)]
        /* 0x72C7 */ public bool SpaceMapShowNexus;
        [NMS(Index = 1195)]
        /* 0x72C8 */ public bool SpaceMapShowNexusLines;
        [NMS(Index = 1189)]
        /* 0x72C9 */ public bool SpaceMapShowPlanetLines;
        [NMS(Index = 1188)]
        /* 0x72CA */ public bool SpaceMapShowPlanets;
        [NMS(Index = 1201)]
        /* 0x72CB */ public bool SpaceMapShowPulseEncounterLines;
        [NMS(Index = 1200)]
        /* 0x72CC */ public bool SpaceMapShowPulseEncounters;
        [NMS(Index = 1197)]
        /* 0x72CD */ public bool SpaceMapShowShipLines;
        [NMS(Index = 1196)]
        /* 0x72CE */ public bool SpaceMapShowShips;
        [NMS(Index = 1190)]
        /* 0x72CF */ public bool SpaceMapShowStation;
        [NMS(Index = 1191)]
        /* 0x72D0 */ public bool SpaceMapShowStationLines;
        [NMS(Index = 508)]
        /* 0x72D1 */ public bool SpaceOnlyLeadTargetEnabled;
        [NMS(Index = 87)]
        /* 0x72D2 */ public bool TechBoxesCanStack;
        [NMS(Index = 753)]
        /* 0x72D3 */ public TkCurveType TrackCritCurve;
        [NMS(Index = 739)]
        /* 0x72D4 */ public TkCurveType TrackReticuleInAngleCurve;
        [NMS(Index = 738)]
        /* 0x72D5 */ public TkCurveType TrackReticuleInCurve;
        [NMS(Index = 89)]
        /* 0x72D6 */ public bool UseIntermediateMissionGiverOptions;
        [NMS(Index = 82)]
        /* 0x72D7 */ public bool UseSquareSlots;
        [NMS(Index = 317)]
        /* 0x72D8 */ public bool UseWorldNodesForRepair;
    }
}
